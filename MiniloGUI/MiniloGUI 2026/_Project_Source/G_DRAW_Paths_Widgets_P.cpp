...
void Paths_Widgets::draw_switch_h_tab(Graphics& g, float& scale, char pos) {
	Path tab{};
	switch (pos)
	{
...
void Paths_Widgets::draw_switch_v_led(Graphics& g, float& scale, char pos, Colour clr) {
	Path led{};
	switch (pos)
	{
...
void Paths_Widgets::draw_switch_v_tab(Graphics& g, float& scale, char pos) {
	Path tab{};
	switch (pos)
	{
...
void Paths_Widgets::switch_osc_octave(Graphics& g, float& scale, int setting) {
	draw_switch_v_slot(g, scale);
	switch (setting)
	{
	case 0: draw_switch_v_tab(g, scale, 'a'); break;
...
void Paths_Widgets::switch_keyboard_octave(Graphics& g, float& scale, int setting) {
