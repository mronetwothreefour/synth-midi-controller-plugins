...
namespace constants
{
	namespace GUI
	{
		...
		static const int randomizationLPFOptions_VertKnobSpacing{ 59 };
		...
		static const int randomizationOptionsComponent_LPFfreq_AllowedOctavesComponent_y{ 268 };
		static const int randomizationOptionsComponent_LFFfreq_CloseButton_x{ 519 };
		static const int randomizationOptionsComponent_LFFfreq_CloseButton_y{ 217 };
		static const int randomizationOptionsComponent_LPFfreq_ModeToggles_y{ 225 };
		static const int randomizationOptionsComponent_LPFfreq_PitchesModeToggle_x{ 364 };
		...
		static const int randomizationValueRangeComponentForLPFfreq_h{ 94 };
		static const int randomizationValueRangeComponentForSeqTrack_h{ knob_diameter };
		static const int randomizationValueRangeComponentForSeqTrack_w{ 100 };
		...
		static const Rectangle<int> bounds_RandomizationLPFfreqOptionsCloseButton{ randomizationOptionsComponent_LFFfreq_CloseButton_x, randomizationOptionsComponent_LFFfreq_CloseButton_y, secondaryWindowsControls_w, secondaryWindowsControls_h };
		static const Rectangle<int> bounds_RandomizationPitchesModeToggleForLPFfreq{ randomizationOptionsComponent_LPFfreq_PitchesModeToggle_x, randomizationOptionsComponent_LPFfreq_ModeToggles_y, toggle_diameter, toggle_diameter };
		...
		static const Rectangle<int> bounds_RandomizationValueRangeModeToggleForLPFfreq{ randomizationOptionsComponent_LPFfreq_ValueRangeModeToggle_x, randomizationOptionsComponent_LPFfreq_ModeToggles_y, toggle_diameter, toggle_diameter };
		static const Rectangle<int> bounds_RandomizationValueRangeForLPFfreq{ randomizationOptionsComponent_LPFfreq_ValueRangeComponent_x, randomizationOptionsComponent_LPFfreq_ValueRangeComponent_y, knob_diameter, randomizationValueRangeComponentForLPFfreq_h };
