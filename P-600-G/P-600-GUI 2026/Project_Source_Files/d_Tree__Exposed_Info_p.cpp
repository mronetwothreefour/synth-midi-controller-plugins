...
Exposed_Parameter_Info::Exposed_Parameter_Info() :
	Tree_Exposed_Info_Base{ EP::exp_param_count }
{
	...
	for (auto osc = 1; osc < 3; ++osc) {
		...
		tree.addChild(
			Build_Tree::exposed_parameter(
				...
				Build_Tree::osc_pitch(EP::choice_count_osc_pitch, curt),
				Build_Tree::osc_pitch(EP::choice_count_osc_pitch)
			),
			-1, nullptr);
		...
		tree.addChild(
			Build_Tree::exposed_parameter(
				...
				osc == 0 ? Build_Tree::off_on(curt) :
						   Build_Tree::unsigned_int(128, curt),
				osc == 0 ? Build_Tree::off_on() :
	...
	tree.addChild(
		Build_Tree::exposed_parameter(
			...
			Build_Tree::unsigned_int(16, curt), Build_Tree::unsigned_int(16)
		),
		-1, nullptr);
	...
	tree.addChild(
		Build_Tree::exposed_parameter(
			...
			Tip_Exp::poly_mod_src_filter_env_amt(), Build_Tree::unsigned_int(16, curt),
			Build_Tree::unsigned_int(16)
		),
		-1, nullptr);
	...
	tree.addChild(
		Build_Tree::exposed_parameter(
			...
			Tip_Exp::poly_mod_src_osc_b_amt(), Build_Tree::unsigned_int(128, curt),
			Build_Tree::unsigned_int(128)
		),
		-1, nullptr);
	...
	tree.addChild(
		Build_Tree::exposed_parameter(
			...
			Build_Tree::unsigned_int(32, curt), Build_Tree::unsigned_int(32)
		),
		-1, nullptr);
