#include "global_VoicesMapSlot.h"
...
void VoicesMapSlot::sliderValueChanged(Slider* slider) {
	...
	if (slider == &slider_ForSettingInVoice)
		globalOptions->setVoicesMapInVoiceForProgramNumber(currentValue, programNumber);
	if (slider == &slider_ForSettingOutProgramNumber)
		globalOptions->setVoicesMapOutVoiceForProgramNumber(currentValue, programNumber);
}
