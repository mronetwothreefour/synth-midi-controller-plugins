...
namespace constants
{
	namespace GUI
	{
		...
		static const int buttonMainWindowVoicesBank_x{ buttonMainWindowPull_x + buttonsHorizSpacingForGroupedButtons };
		...
		static const int buttonVoicesBankWindowExit_x{ 1336 };
		static const int buttonVoicesBankWindowLoadSelectedVoice_x{ 360 };
		static const int buttonVoicesBankWindowSaveVoice_x{ buttonVoicesBankWindowLoadSelectedVoice_x + buttonsHorizSpacingForGroupedButtons };
		static const int buttonVoicesBankWindowPullSelectedVoice_x{ buttonVoicesBankWindowSaveVoice_x + buttonsHorizSpacingForGroupedButtons };
		static const int buttonVoicesBankWindowImptVoice_x{ buttonVoicesBankWindowPullSelectedVoice_x + buttonsHorizSpacingForGroupedButtons };
		static const int buttonVoicesBankWindowExptSelectedVoice_x{ buttonVoicesBankWindowImptVoice_x + buttonsHorizSpacingForGroupedButtons };
		static const int buttonVoicesBankWindowNameSelectedVoice_x{ buttonVoicesBankWindowExptSelectedVoice_x + buttonsHorizSpacingForGroupedButtons };
		static const int buttonVoicesBankPullBank_x{ 780 };
		static const int buttonVoicesBankPushBank_x{ buttonVoicesBankPullBank_x + buttonsHorizSpacingForGroupedButtons };
		static const int buttonVoicesBankImptBank_x{ buttonVoicesBankPushBank_x + buttonsHorizSpacingForGroupedButtons };
		static const int buttonVoicesBankExptBank_x{ buttonVoicesBankImptBank_x + buttonsHorizSpacingForGroupedButtons };
		static const int buttonVoicesBankFact_x{ buttonVoicesBankExptBank_x + buttonsHorizSpacingForGroupedButtons };
		...
		static const int voicesBankWindowButtonsRow_y{ 84 };
		static const int voicesBankWindow_h{ 270 };
		static const int voicesBankWindow_w{ 1380 };
		static const int voicesBankWindow_x{ 11 };
		static const int voicesBankWindow_y{ 61 };
		static const int voiceNameEditorLabel_horizInset{ 43 };
		static const int voiceNameEditorLabel_w{ 118 };
		static const int voiceSlotRadioButton_h{ 16 };
		static const int voiceSlotRadioButton_w{ 135 };
		static const int voiceSlotsComponent_h{ 160 };
		static const int voiceSlotsComponent_w{ 1350 };
		static const int voiceSlotsComponent_x{ 26 };
		static const int voiceSlotsComponent_y{ 156 };
		...
		static const Rectangle<int> bounds_VoicesBankWindow{ voicesBankWindow_x, voicesBankWindow_y, voicesBankWindow_w, voicesBankWindow_h };
		static const Rectangle<int> bounds_VoicesBankWindowExitButton{ buttonVoicesBankWindowExit_x, voicesBankWindowButtonsRow_y, buttons_w, buttons_h };
		static const Rectangle<int> bounds_VoicesBankWindowExptBankButton{ buttonVoicesBankExptBank_x, voicesBankWindowButtonsRow_y, buttons_w, buttons_h };
		static const Rectangle<int> bounds_VoicesBankWindowExptSelectedVoiceButton{ buttonVoicesBankWindowExptSelectedVoice_x, voicesBankWindowButtonsRow_y, buttons_w, buttons_h };
		static const Rectangle<int> bounds_VoicesBankWindowFactButton{ buttonVoicesBankFact_x, voicesBankWindowButtonsRow_y, buttons_w, buttons_h };
		static const Rectangle<int> bounds_VoicesBankWindowImptVoiceButton{ buttonVoicesBankWindowImptVoice_x, voicesBankWindowButtonsRow_y, buttons_w, buttons_h };
		static const Rectangle<int> bounds_VoicesBankWindowImptBankButton{ buttonVoicesBankImptBank_x, voicesBankWindowButtonsRow_y, buttons_w, buttons_h };
		static const Rectangle<int> bounds_VoicesBankWindowLoadSelectedVoiceButton{ buttonVoicesBankWindowLoadSelectedVoice_x, voicesBankWindowButtonsRow_y, buttons_w, buttons_h };
		static const Rectangle<int> bounds_VoicesBankWindowNameButton{ buttonVoicesBankWindowNameSelectedVoice_x, voicesBankWindowButtonsRow_y, buttons_w, buttons_h };
		static const Rectangle<int> bounds_VoicesBankWindowPullBankButton{ buttonVoicesBankPullBank_x, voicesBankWindowButtonsRow_y, buttons_w, buttons_h };
		static const Rectangle<int> bounds_VoicesBankWindowPushBankButton{ buttonVoicesBankPushBank_x, voicesBankWindowButtonsRow_y, buttons_w, buttons_h };
		static const Rectangle<int> bounds_VoicesBankWindowPullSelectedVoiceButton{ buttonVoicesBankWindowPullSelectedVoice_x, voicesBankWindowButtonsRow_y, buttons_w, buttons_h };
		static const Rectangle<int> bounds_VoicesBankWindowSaveVoiceButton{ buttonVoicesBankWindowSaveVoice_x, voicesBankWindowButtonsRow_y, buttons_w, buttons_h };
		static const Rectangle<int> bounds_VoicesBankWindowTransmitTimeEditor{ 1155, 76, lcdDisplay4digit_w, lcdDisplay_h };
		static const Rectangle<int> bounds_VoiceNumberSlider{ 408, 42, lcdDisplay2digit_w, lcdDisplay_h };
		static const Rectangle<int> bounds_VoiceSlotsComponent{ voiceSlotsComponent_x, voiceSlotsComponent_y, voiceSlotsComponent_w, voiceSlotsComponent_h };
