...
namespace constants
{
	namespace GUI
	{
		...
		static const int randomizationSeqTrackOptionsComponentsRow1_y{ 258 };
		...
		static const int randomizationSeqTrackOptionsBackground_y{ 189 };
		...
		static const int randomizationProbabilitiesForSeqTrack1Component_x{ 454 };
		static const int randomizationProbabilitiesForSeqTracks2_3_4Component_w{ 126 };
		static const int randomizationProbabilitiesForSeqTracks2_3_4Component_x{ 475 };
		...
		static const int randomizationSeqTrackRepeatValuesToggle_x{ 504 };
		static const int randomizationSeqTrackRepeatValuesToggle_y{ 208 };
		...
		static const int randomizationSeqTrackOptionsCloseButton_x{ 725 };
		static const int randomizationSeqTrackOptionsCloseButton_y{ 204 };
		...
		static const Rectangle<int> bounds_RandomizationAllowedNotesForSeqTrack{ randomizationAllowedNotesComponentForSeqTrack_x, randomizationSeqTrackOptionsComponentsRow2_y, randomizationAllowedNotesComponentForSeqTrack_w, randomizationAllowedNotesComponent_h };
		...
		static const Rectangle<int> bounds_RandomizationAllowedOctavesForSeqTrack{ randomizationAllowedOctavesComponentForSeqTrack_x, randomizationSeqTrackOptionsComponentsRow2_y, randomizationAllowedOctavesForLFOandSeqTrackComponents_w, randomizationAllowedOctavesForLFOandSeqTrackComponents_h };
		...
		static const Rectangle<int> bounds_RandomizationEditModeForSeqTrack{ randomizationEditModeForSeqTrackComponent_x, randomizationSeqTrackOptionsComponentsRow1_y, randomizationEditModeForSeqTrackComponent_w, randomizationEditModeForSeqTrackComponent_h };
		...
		static const Rectangle<int> bounds_RandomizationProbabilitiesForSeqTrack1{ randomizationProbabilitiesForSeqTrack1Component_x, randomizationSeqTrackOptionsComponentsRow1_y, randomizationProbabilitiesForSeqTrack1Component_w, randomizationProbabilitiesForSeqTrackComponent_h };
		static const Rectangle<int> bounds_RandomizationProbabilitiesForSeqTrack2_3_4{ randomizationProbabilitiesForSeqTracks2_3_4Component_x, randomizationSeqTrackOptionsComponentsRow1_y, randomizationProbabilitiesForSeqTracks2_3_4Component_w, randomizationProbabilitiesForSeqTrackComponent_h };
		...
		static const Rectangle<int> bounds_RandomizationSeqTrackOptionsCloseButton{ randomizationSeqTrackOptionsCloseButton_x, randomizationSeqTrackOptionsCloseButton_y, secondaryWindowsControls_w, secondaryWindowsControls_h };
		static const Rectangle<int> bounds_RandomizationSeqTrackOptionsRepeatValuesToggle{ randomizationSeqTrackRepeatValuesToggle_x, randomizationSeqTrackRepeatValuesToggle_y, randomizationRepeatValuesComponents_w, randomizationRepeatValuesComponents_h };
		...
		static const Rectangle<int> bounds_RandomizationValueRangeForSeqTrack{ randomizationValueRangeComponentForSeqTrack_x, randomizationSeqTrackOptionsComponentsRow1_y, randomizationValueRangeComponentForSeqTrack_w, randomizationValueRangeComponentForSeqTrack_h };
