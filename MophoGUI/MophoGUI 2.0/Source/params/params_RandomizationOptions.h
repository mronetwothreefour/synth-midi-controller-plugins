...
public:
	...
	void setProbabilityOfRepeatForAllStepsInSeqTrack1(float newProb, int trackNum);
	...
	void setProbabilityOfResetForAllStepsInSeqTrack1(float newProb, int trackNum);
