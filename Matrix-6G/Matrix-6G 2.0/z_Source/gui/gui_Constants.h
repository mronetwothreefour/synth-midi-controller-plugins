...
namespace constants
{
	namespace GUI
	{
		...
		static const float voiceNameFirstCharacter_x{ 881.0f };
		static const float voiceNameCharacters_y{ 370.0f };
		static const float voiceNameCharacter_w{ 11.0f };
		static const float voiceNameGapBetweenCharacters{ 2.0f };
		...
		static const int globalOptionsControlsCol1and2_w{ 37 };
		static const int globalOptionsControlsCol1_x{ 403 };
		static const int globalOptionsControlsCol2_x{ 568 };
		static const int globalOptionsControlsCol3_w{ 70 };
		static const int globalOptionsControlsCol3_x{ 707 };
		static const int globalOptionsControlsCol4_w{ 48 };
		static const int globalOptionsControlsCol4_x{ 880 };
		static const int globalOptionsControlsRow1_y{ 194 };
		static const int globalOptionsControlsRow2_y{ globalOptionsControlsRow1_y + controlsVerticalGap };
		static const int globalOptionsControlsRow3_y{ globalOptionsControlsRow2_y + controlsVerticalGap };
		static const int globalOptionsControlsRow4_y{ globalOptionsControlsRow3_y + controlsVerticalGap };
		static const int globalOptionsControlsRow5_y{ globalOptionsControlsRow4_y + controlsVerticalGap };
		static const int globalOptionsControlsRow6_y{ globalOptionsControlsRow5_y + controlsVerticalGap };
		static const int globalOptionsControlsRow7_y{ globalOptionsControlsRow6_y + controlsVerticalGap };
		static const int globalOptionsControlsRow8_y{ globalOptionsControlsRow7_y + controlsVerticalGap };
		static const int globalOptionsControlsRow9_y{ globalOptionsControlsRow8_y + controlsVerticalGap };
		static const int globalOptionsWindow_x{ 299 };
		static const int globalOptionsWindow_y{ 129 };
		...
		static const int splitZoneVoiceNumber_w{ 26 };
		static const int splitZoneVoiceNumber_x{ 596 };
		...
		static const int voicesBanksCustomTabLoadButton_x{ 116 };
		static const int voicesBanksCustomTabPullEntireBankButton_x{ 340 };
		static const int voicesBanksCustomTabPullSelectedVoiceButton_x{ 194 };
		static const int voicesBanksCustomTabPushButton_x{ 301 };
		static const int voicesBanksCustomTabSaveButton_x{ 155 };
		static const int voicesBanksFactoryTabLoadButton_x{ 173 };
		static const int voicesBanksFactoryTabPushBankButton_x{ 283 };
		static const int voicesBanksHeaderControls_y{ 77 };
		static const int voicesBanksTab_h{ 466 };
		static const int voicesBanksTab_w{ 420 };
		static const int voicesBanksTabBarDepth{ 0 };
		static const int voicesBanksTabButtons_y{ 427 };
		static const int voicesBanksTabFooter_x{ 0 };
		static const int voicesBanksTabFooter_y{ 422 };
		static const int voicesMapSlot_h{ controls_h };
		static const int voicesMapSlot_w{ 57 };
		static const int voicesMapSlotInSlider_x{ 0 };
		static const int voicesMapSlotOutSlider_x{ 31 };
		static const int voicesMapSlotsColumn_h{ 272 };
		static const int voicesMapSlotsColumn_w{ voicesMapSlot_w };
		static const int voicesMapSlotsSpaceBetweenColumns{ 87 };
		static const int voicesMapSlotsColumn_0_x{ 213 };
		static const int voicesMapSlotsColumn_1_x{ voicesMapSlotsColumn_0_x + voicesMapSlotsSpaceBetweenColumns };
		static const int voicesMapSlotsColumn_2_x{ voicesMapSlotsColumn_1_x + voicesMapSlotsSpaceBetweenColumns };
		static const int voicesMapSlotsColumn_3_x{ voicesMapSlotsColumn_2_x + voicesMapSlotsSpaceBetweenColumns };
		static const int voicesMapSlotsColumn_4_x{ voicesMapSlotsColumn_3_x + voicesMapSlotsSpaceBetweenColumns };
		static const int voicesMapSlotsColumn_5_x{ voicesMapSlotsColumn_4_x + voicesMapSlotsSpaceBetweenColumns };
		static const int voicesMapSlotsColumn_6_x{ voicesMapSlotsColumn_5_x + voicesMapSlotsSpaceBetweenColumns };
		static const int voicesMapSlotsColumn_7_x{ voicesMapSlotsColumn_6_x + voicesMapSlotsSpaceBetweenColumns };
		static const int voicesMapSlotsColumn_8_x{ voicesMapSlotsColumn_7_x + voicesMapSlotsSpaceBetweenColumns };
		static const int voicesMapSlotsColumn_9_x{ voicesMapSlotsColumn_8_x + voicesMapSlotsSpaceBetweenColumns };
		static const int voicesMapSlotsColumns_y{ 184 };
		static const int voicesMapSlotSliders_w{ 26 };
		static const int voicesMapSlotSliders_y{ 0 };
		static const int voicesMapWindow_x{ 173 };
		static const int voicesMapWindow_y{ 111 };
		static const int voiceSlotRadioButtton_h{ 16 };
		static const int voiceSlotRadioButtton_w{ 81 };
		static const int voiceSlotRadioButtonsHorizontalGap{ 22 };
		static const int voiceSlotsComponent_h{ 25 * voiceSlotRadioButtton_h };
		static const int voiceSlotsComponent_w{ 4 * voiceSlotRadioButtton_w + 3 * voiceSlotRadioButtonsHorizontalGap };
		...
		static const Rectangle<int> bounds_MainWindowGlobalOptionsButton{ 1164, mainWindowLargeButtons_y, largeButtons_w, largeButtons_h };
		...
		static const Rectangle<int> bounds_MainWindowVoicesButton{ 1006, mainWindowLargeButtons_y, largeButtons_w, largeButtons_h };
		static const Rectangle<int> bounds_MainWindowWebLinkButton{ 176, 386, 146, 9 };
		static const Rectangle<int> bounds_GlobalOptionsComponentXbutton{ 935, 129, xButton_w, xButton_h };
		static const Rectangle<int> bounds_GlobalOptionsComponentComboBoxForActiveSensing{ globalOptionsControlsCol2_x, globalOptionsControlsRow2_y, globalOptionsControlsCol1and2_w, controls_h };
		static const Rectangle<int> bounds_GlobalOptionsComponentComboBoxForControllers{ globalOptionsControlsCol1_x, globalOptionsControlsRow3_y, globalOptionsControlsCol1and2_w, controls_h };
		static const Rectangle<int> bounds_GlobalOptionsComponentComboBoxForDescriptionTips{ globalOptionsControlsCol4_x, globalOptionsControlsRow7_y, globalOptionsControlsCol4_w, controls_h };
		static const Rectangle<int> bounds_GlobalOptionsComponentComboBoxForLocalControl{ globalOptionsControlsCol2_x, globalOptionsControlsRow3_y, globalOptionsControlsCol1and2_w, controls_h };
		static const Rectangle<int> bounds_GlobalOptionsComponentComboBoxForMIDIecho{ globalOptionsControlsCol1_x, globalOptionsControlsRow7_y, globalOptionsControlsCol1and2_w, controls_h };
		static const Rectangle<int> bounds_GlobalOptionsComponentComboBoxForMIDImono{ globalOptionsControlsCol2_x, globalOptionsControlsRow1_y, globalOptionsControlsCol1and2_w, controls_h };
		static const Rectangle<int> bounds_GlobalOptionsComponentComboBoxForOmniMode{ globalOptionsControlsCol1_x, globalOptionsControlsRow2_y, globalOptionsControlsCol1and2_w, controls_h };
		static const Rectangle<int> bounds_GlobalOptionsComponentComboBoxForVoiceChanges{ globalOptionsControlsCol1_x, globalOptionsControlsRow4_y, globalOptionsControlsCol1and2_w, controls_h };
		static const Rectangle<int> bounds_GlobalOptionsComponentComboBoxForVoiceMapEcho{ globalOptionsControlsCol4_x, globalOptionsControlsRow4_y, globalOptionsControlsCol4_w, controls_h };
		static const Rectangle<int> bounds_GlobalOptionsComponentComboBoxForVoiceMap{ globalOptionsControlsCol4_x, globalOptionsControlsRow3_y, globalOptionsControlsCol4_w, controls_h };
		static const Rectangle<int> bounds_GlobalOptionsComponentComboBoxForSpillover{ globalOptionsControlsCol1_x, globalOptionsControlsRow6_y, globalOptionsControlsCol1and2_w, controls_h };
		static const Rectangle<int> bounds_GlobalOptionsComponentComboBoxForSplitStereo{ globalOptionsControlsCol4_x, globalOptionsControlsRow2_y, globalOptionsControlsCol4_w, controls_h };
		static const Rectangle<int> bounds_GlobalOptionsComponentComboBoxForSQUICK{ globalOptionsControlsCol4_x, globalOptionsControlsRow6_y, globalOptionsControlsCol4_w, controls_h };
		static const Rectangle<int> bounds_GlobalOptionsComponentComboBoxForSysEx{ globalOptionsControlsCol1_x, globalOptionsControlsRow5_y, globalOptionsControlsCol1and2_w, controls_h };
		static const Rectangle<int> bounds_GlobalOptionsComponentComboBoxForValueTips{ globalOptionsControlsCol4_x, globalOptionsControlsRow8_y, globalOptionsControlsCol4_w, controls_h };
		static const Rectangle<int> bounds_GlobalOptionsComponentComboBoxForVibratoAmpModSource{ globalOptionsControlsCol3_x, globalOptionsControlsRow6_y, globalOptionsControlsCol3_w, controls_h };
		static const Rectangle<int> bounds_GlobalOptionsComponentComboBoxForVibratoSpeedModSource{ globalOptionsControlsCol3_x, globalOptionsControlsRow4_y, globalOptionsControlsCol3_w, controls_h };
		static const Rectangle<int> bounds_GlobalOptionsComponentComboBoxForVibratoWaveType{ globalOptionsControlsCol3_x, globalOptionsControlsRow2_y, globalOptionsControlsCol3_w, controls_h };
		static const Rectangle<int> bounds_GlobalOptionsComponentEditbutton{ 406, globalOptionsControlsRow9_y, smallButtons_w, smallButtons_h };
		static const Rectangle<int> bounds_GlobalOptionsComponentPushbutton{ 510, globalOptionsControlsRow9_y, smallButtons_w, smallButtons_h };
		static const Rectangle<int> bounds_GlobalOptionsComponentSliderForBasicChannel { globalOptionsControlsCol1_x, globalOptionsControlsRow1_y, globalOptionsControlsCol1and2_w, controls_h };
		static const Rectangle<int> bounds_GlobalOptionsComponentSliderForDisplayBrightness { globalOptionsControlsCol4_x, globalOptionsControlsRow5_y, globalOptionsControlsCol4_w, controls_h };
		static const Rectangle<int> bounds_GlobalOptionsComponentSliderForLever2Controller { globalOptionsControlsCol2_x, globalOptionsControlsRow6_y, globalOptionsControlsCol1and2_w, controls_h };
		static const Rectangle<int> bounds_GlobalOptionsComponentSliderForLever3Controller { globalOptionsControlsCol2_x, globalOptionsControlsRow7_y, globalOptionsControlsCol1and2_w, controls_h };
		static const Rectangle<int> bounds_GlobalOptionsComponentSliderForGlobalTune { globalOptionsControlsCol4_x, globalOptionsControlsRow1_y, globalOptionsControlsCol4_w, controls_h };
		static const Rectangle<int> bounds_GlobalOptionsComponentSliderForPedal1Controller{ globalOptionsControlsCol2_x, globalOptionsControlsRow4_y, globalOptionsControlsCol1and2_w, controls_h };
		static const Rectangle<int> bounds_GlobalOptionsComponentSliderForPedal2Controller{ globalOptionsControlsCol2_x, globalOptionsControlsRow5_y, globalOptionsControlsCol1and2_w, controls_h };
		static const Rectangle<int> bounds_GlobalOptionsComponentSliderForVibratoAmplitude{ globalOptionsControlsCol3_x, globalOptionsControlsRow3_y, globalOptionsControlsCol3_w, controls_h };
		static const Rectangle<int> bounds_GlobalOptionsComponentSliderForVibratoAmplitudeModAmount{ globalOptionsControlsCol3_x, globalOptionsControlsRow7_y, globalOptionsControlsCol3_w, controls_h };
		static const Rectangle<int> bounds_GlobalOptionsComponentSliderForVibratoSpeed{ globalOptionsControlsCol3_x, globalOptionsControlsRow1_y, globalOptionsControlsCol3_w, controls_h };
		static const Rectangle<int> bounds_GlobalOptionsComponentSliderForVibratoSpeedModAmount{ globalOptionsControlsCol3_x, globalOptionsControlsRow5_y, globalOptionsControlsCol3_w, controls_h };
		static const Rectangle<int> bounds_GlobalOptionsComponentTipsDelayEditor{ globalOptionsControlsCol4_x, globalOptionsControlsRow9_y, globalOptionsControlsCol4_w, controls_h };
		...
		static const Rectangle<int> bounds_SplitLowerZoneVoiceNumber{ splitZoneVoiceNumber_x, splitsControlsRow3_y, splitZoneVoiceNumber_w, controls_h };
		...
		static const Rectangle<int> bounds_SplitUpperZoneVoiceNumber{ splitZoneVoiceNumber_x, splitsControlsRow4_y, splitZoneVoiceNumber_w, controls_h };
		...
		static const Rectangle<int> bounds_TabbedComponentForVoicesBanks{ 416, 102, voicesBanksTab_w, voicesBanksTab_h };
		static const Rectangle<int> bounds_VoiceNameEditor{ 873, 367, 117, controls_h };
		static const Rectangle<int> bounds_VoiceNumberSlider{ 840, 367, 28, controls_h };
		static const Rectangle<int> bounds_VoicesBanksCustomTabLoadButton{ voicesBanksCustomTabLoadButton_x, voicesBanksTabButtons_y, smallButtons_w, smallButtons_h };
		static const Rectangle<int> bounds_VoicesBanksCustomTabPullEntireBankButton{ voicesBanksCustomTabPullEntireBankButton_x, voicesBanksTabButtons_y, smallButtons_w, smallButtons_h };
		static const Rectangle<int> bounds_VoicesBanksCustomTabPullSelectedVoiceButton{ voicesBanksCustomTabPullSelectedVoiceButton_x, voicesBanksTabButtons_y, smallButtons_w, smallButtons_h };
		static const Rectangle<int> bounds_VoicesBanksCustomTabPushButton{ voicesBanksCustomTabPushButton_x, voicesBanksTabButtons_y, smallButtons_w, smallButtons_h };
		static const Rectangle<int> bounds_VoicesBanksCustomTabSaveButton{ voicesBanksCustomTabSaveButton_x, voicesBanksTabButtons_y, smallButtons_w, smallButtons_h };
		static const Rectangle<int> bounds_VoicesBanksFactoryTabLoadButton{ voicesBanksFactoryTabLoadButton_x, voicesBanksTabButtons_y, smallButtons_w, smallButtons_h };
		static const Rectangle<int> bounds_VoicesBanksFactoryTabPushBankButton{ voicesBanksFactoryTabPushBankButton_x, voicesBanksTabButtons_y, smallButtons_w, smallButtons_h };
		static const Rectangle<int> bounds_VoicesBanksSelectorComboBox{ 488, voicesBanksHeaderControls_y, 184, controls_h };
		static const Rectangle<int> bounds_VoicesBanksTransmitTimeLabel{ 771, voicesBanksHeaderControls_y, 50, controls_h };
		static const Rectangle<int> bounds_VoicesBanksWindow{ 416, 28, 420, 540 };
		static const Rectangle<int> bounds_VoicesBanksXbutton{ 828, 18, xButton_w, xButton_h };
		static const Rectangle<int> bounds_VoiceSlotsComponent{ 15, 11, voiceSlotsComponent_w, voiceSlotsComponent_h };
		static const Rectangle<int> bounds_VoicesMapComponentXbutton{ 1061, 111, xButton_w, xButton_h };
		static const Rectangle<int> bounds_VoicesMapResetButton{ 1013, 144, 40, 14 };
		static const Rectangle<int> bounds_VoicesMapSlotInSlider{ voicesMapSlotInSlider_x, voicesMapSlotSliders_y, voicesMapSlotSliders_w, controls_h };
		static const Rectangle<int> bounds_VoicesMapSlotOutSlider{ voicesMapSlotOutSlider_x, voicesMapSlotSliders_y, voicesMapSlotSliders_w, controls_h };
		static const Rectangle<int> bounds_VoicesMapSlotsColumn_0{ voicesMapSlotsColumn_0_x, voicesMapSlotsColumns_y, voicesMapSlotsColumn_w, voicesMapSlotsColumn_h };
		static const Rectangle<int> bounds_VoicesMapSlotsColumn_1{ voicesMapSlotsColumn_1_x, voicesMapSlotsColumns_y, voicesMapSlotsColumn_w, voicesMapSlotsColumn_h };
		static const Rectangle<int> bounds_VoicesMapSlotsColumn_2{ voicesMapSlotsColumn_2_x, voicesMapSlotsColumns_y, voicesMapSlotsColumn_w, voicesMapSlotsColumn_h };
		static const Rectangle<int> bounds_VoicesMapSlotsColumn_3{ voicesMapSlotsColumn_3_x, voicesMapSlotsColumns_y, voicesMapSlotsColumn_w, voicesMapSlotsColumn_h };
		static const Rectangle<int> bounds_VoicesMapSlotsColumn_4{ voicesMapSlotsColumn_4_x, voicesMapSlotsColumns_y, voicesMapSlotsColumn_w, voicesMapSlotsColumn_h };
		static const Rectangle<int> bounds_VoicesMapSlotsColumn_5{ voicesMapSlotsColumn_5_x, voicesMapSlotsColumns_y, voicesMapSlotsColumn_w, voicesMapSlotsColumn_h };
		static const Rectangle<int> bounds_VoicesMapSlotsColumn_6{ voicesMapSlotsColumn_6_x, voicesMapSlotsColumns_y, voicesMapSlotsColumn_w, voicesMapSlotsColumn_h };
		static const Rectangle<int> bounds_VoicesMapSlotsColumn_7{ voicesMapSlotsColumn_7_x, voicesMapSlotsColumns_y, voicesMapSlotsColumn_w, voicesMapSlotsColumn_h };
		static const Rectangle<int> bounds_VoicesMapSlotsColumn_8{ voicesMapSlotsColumn_8_x, voicesMapSlotsColumns_y, voicesMapSlotsColumn_w, voicesMapSlotsColumn_h };
		static const Rectangle<int> bounds_VoicesMapSlotsColumn_9{ voicesMapSlotsColumn_9_x, voicesMapSlotsColumns_y, voicesMapSlotsColumn_w, voicesMapSlotsColumn_h };
