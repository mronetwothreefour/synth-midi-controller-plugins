...
namespace constants
{
	namespace GUI
	{
		...
		static const int randomizationAllowAllNotesForOscButtons_x{ 39 };
		static const int randomizationAllowAllNotesForOscButtons_y{ 53 };
		static const int randomizationAllowAllOctavesForOscButtons_w{ 82 };
		static const int randomizationAllowAllOctavesForOscButtons_x{ 22 };
		static const int randomizationAllowAllOctavesForOscButtons_y{ 70 };
		static const int randomizationAllowedNotesForOsc1Component_x{ 473 };
		static const int randomizationAllowedNotesForOsc2Component_x{ 651 };
		static const int randomizationAllowedNotesForOscComponents_y{ 228 };
		static const int randomizationAllowedNotesForOscComponent_h{ 75 };
		static const int randomizationAllowedNotesForOscComponent_w{ 148 };
		...
		static const int randomizationAllowedOctavesForOsc1Component_x{ 484 };
		static const int randomizationAllowedOctavesForOsc2Component_x{ 662 };
		static const int randomizationAllowedOctavesForOscComponents_y{ 337 };
		static const int randomizationAllowedOctavesForOscComponent_h{ 92 };
		static const int randomizationAllowedOctavesForOscComponent_w{ 126 };
		...
		static const int randomizationOscOptionsCloseButton_x{ 612 };
		...
		static const Rectangle<int> bounds_RandomizationAllowAllNotesForOscButton{ randomizationAllowAllNotesForOscButtons_x, randomizationAllowAllNotesForOscButtons_y, randomizationAllowAllNotesForOscButtons_w, secondaryWindowsControls_h };
		static const Rectangle<int> bounds_RandomizationAllowAllOctavesForOscButton{ randomizationAllowAllOctavesForOscButtons_x, randomizationAllowAllOctavesForOscButtons_y, randomizationAllowAllOctavesForOscButtons_w, secondaryWindowsControls_h };
		static const Rectangle<int> bounds_RandomizationAllowedNotesForOsc1{ randomizationAllowedNotesForOsc1Component_x, randomizationAllowedNotesForOscComponents_y, randomizationAllowedNotesForOscComponent_w, randomizationAllowedNotesForOscComponent_h };
		static const Rectangle<int> bounds_RandomizationAllowedNotesForOsc2{ randomizationAllowedNotesForOsc2Component_x, randomizationAllowedNotesForOscComponents_y, randomizationAllowedNotesForOscComponent_w, randomizationAllowedNotesForOscComponent_h };
