#include "widget_global_ComboBoxForSelectingVibratoModSource.h"
	...
	propertyID{ propertyID }
{
	...
	auto paramValue{ propertyID == ID::global_VibratoAmplitudeModSource ? globalOptions->vibratoAmplitudeModSource() : globalOptions->vibratoSpeedModSource() };
