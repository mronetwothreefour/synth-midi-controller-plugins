...
Exposed_Parameter_Info::Exposed_Parameter_Info() :
	Tree_Exposed_Info_Base{ exp_param_count }
{
	...
	tree.addChild(
		Sub_Tree_Exposed::build(
			...
			Tip_Exp::poly_mod_src_filter_env_amt(), Choices_Exp::unsigned_int(16, curt),
	...
	tree.addChild(
		Sub_Tree_Exposed::build(
			...
			Tip_Exp::poly_mod_src_osc_b_amt(), Choices_Exp::unsigned_int(128, curt),
