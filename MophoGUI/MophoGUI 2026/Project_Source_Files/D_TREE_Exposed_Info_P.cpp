	...
	Tree_Exposed_Info_B{ EXP::exp_param_count }
{
	...
	for (auto osc = 1; osc < 3; ++osc) {
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				"Oscillator " + n + " Pitch", Ctrl_Type::knob_pitch, Knob_Editor_Type::osc_pitch,
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				Knob_Editor_Type::osc_fine, osc == 1 ? 1 : 6,
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				Knob_Editor_Type::osc_shape, osc == 1 ? 2 : 7, choice_count_osc_shape, 1,
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				Knob_Editor_Type::unsigned_7_bit, osc == 1 ? 3 : 8, 128, 0,
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				Knob_Editor_Type::none, osc == 1 ? 4 : 9, 2, 1, ctrl_col_6_x, center_y + 11, 32, 36,
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				Knob_Editor_Type::unsigned_7_bit, osc == 1 ? 114 : 115, 128, 0, ctrl_col_5_x,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			Knob_Editor_Type::none, 10, 2, 0, 242, 22, 76, toggle_diameter,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			Knob_Editor_Type::none, 11, 4, 0, ctrl_col_10_x, 78, osc_cbox_w, cbox_h,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			Knob_Editor_Type::osc_slop, 12, 6, 2, ctrl_col_7_x, osc_row_1_y, 
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			Knob_Editor_Type::pitch_bend, 93, choice_count_bend_range, 4, ctrl_col_9_x, osc_row_1_y,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			Knob_Editor_Type::none, 96, 6, 4, ctrl_col_10_x, 38,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			Knob_Editor_Type::unsigned_7_bit, 13, 128, 64, ctrl_col_8_x, osc_row_1_y,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			Knob_Editor_Type::unsigned_7_bit, 14, 128, 0, ctrl_col_7_x, osc_row_2_y,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			Knob_Editor_Type::unsigned_7_bit, 116, 128, 0, ctrl_col_8_x, osc_row_2_y,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			ID::exp_020_lpf_freq, "LPF Cutoff Frequency", Ctrl_Type::knob_pitch, Knob_Editor_Type::lpf_freq,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			ID::exp_021_lpf_reso, "LPF Resonance", Ctrl_Type::knob, Knob_Editor_Type::unsigned_7_bit,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			ID::exp_022_lpf_key_amt, "LPF Keyboard Amount", Ctrl_Type::knob, Knob_Editor_Type::unsigned_7_bit,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			ID::exp_023_lpf_fm_amt, "LPF FM (By Oscillator 1)", Ctrl_Type::knob, Knob_Editor_Type::unsigned_7_bit,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			ID::exp_024_lpf_type, "LPF Type", Ctrl_Type::toggle, Knob_Editor_Type::none,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			ID::exp_025_lpf_env_amt, "LPF Envelope Amount", Ctrl_Type::knob, Knob_Editor_Type::signed_8_bit,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			Knob_Editor_Type::unsigned_7_bit, 21, 128, 0, ctrl_col_2_x, lpf_row_3_y,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			ID::exp_027_lpf_delay, "LPF Envelope Delay", Ctrl_Type::knob, Knob_Editor_Type::unsigned_7_bit,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			ID::exp_028_lpf_attack, "LPF Envelope Attack", Ctrl_Type::knob, Knob_Editor_Type::unsigned_7_bit,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			ID::exp_029_lpf_decay, "LPF Envelope Decay", Ctrl_Type::knob, Knob_Editor_Type::unsigned_7_bit,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			ID::exp_030_lpf_sustain, "LPF Envelope Sustain", Ctrl_Type::knob, Knob_Editor_Type::unsigned_7_bit,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			ID::exp_031_lpf_release, "LPF Envelope Release", Ctrl_Type::knob, Knob_Editor_Type::unsigned_7_bit,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			ID::exp_032_vca_level, "VCA Baseline Level", Ctrl_Type::knob, Knob_Editor_Type::unsigned_7_bit,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			ID::exp_033_vca_env_amt, "VCA Envelope Amount", Ctrl_Type::knob, Knob_Editor_Type::unsigned_7_bit,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			Knob_Editor_Type::unsigned_7_bit, 31, 128, 0, ctrl_col_3_x, vca_row_1_y,
			knob_diameter, knob_diameter, Tip_Exp::env_velo_amt(env_name),
			Choices_Exp::unsigned_int(128, curt), Choices_Exp::unsigned_int(128)
		),
		-1, nullptr);
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			ID::exp_035_vca_delay, "VCA Envelope Delay", Ctrl_Type::knob, Knob_Editor_Type::unsigned_7_bit,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			ID::exp_036_vca_attack, "VCA Envelope Attack", Ctrl_Type::knob, Knob_Editor_Type::unsigned_7_bit,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			ID::exp_037_vca_decay, "VCA Envelope Decay", Ctrl_Type::knob, Knob_Editor_Type::unsigned_7_bit,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			ID::exp_038_vca_sustain, "VCA Envelope Sustain", Ctrl_Type::knob, Knob_Editor_Type::unsigned_7_bit,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			ID::exp_039_vca_release, "VCA Envelope Release", Ctrl_Type::knob, Knob_Editor_Type::unsigned_7_bit,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			ID::exp_040_voice_volume, "Program Volume", Ctrl_Type::knob, Knob_Editor_Type::unsigned_7_bit,
	...
	for (int lfo = 0; lfo < 4; ++lfo) {
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				"LFO " + n + " Frequency", Ctrl_Type::knob, Knob_Editor_Type::lfo_freq,
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				"LFO " + n + " Wave Shape", Ctrl_Type::cbox, Knob_Editor_Type::none,
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				"LFO " + n + " Amount", Ctrl_Type::knob, Knob_Editor_Type::unsigned_7_bit,
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				"LFO " + n + " Modulation Destination", Ctrl_Type::cbox, Knob_Editor_Type::none,
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				"LFO " + n + " Key Sync On / Off", Ctrl_Type::toggle, Knob_Editor_Type::none,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			Knob_Editor_Type::none, 57, EXP::choice_count_mod_dest, 0, ctrl_col_2_x, env_3_row_2_y,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			ID::exp_062_env_3_amount, "Envelope 3 Amount", Ctrl_Type::knob, Knob_Editor_Type::signed_8_bit,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			Knob_Editor_Type::unsigned_7_bit, 59, 128, 0, ctrl_col_3_x, env_3_row_1_y,
			knob_diameter, knob_diameter, Tip_Exp::env_velo_amt(env_name),
			Choices_Exp::unsigned_int(128, curt), Choices_Exp::unsigned_int(128)
		),
		-1, nullptr);
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			ID::exp_064_env_3_delay, "Envelope 3 Delay", Ctrl_Type::knob, Knob_Editor_Type::unsigned_7_bit,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			ID::exp_065_env_3_attack, "Envelope 3 Attack", Ctrl_Type::knob, Knob_Editor_Type::unsigned_7_bit,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			ID::exp_066_env_3_decay, "Envelope 3 Decay", Ctrl_Type::knob, Knob_Editor_Type::unsigned_7_bit,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			ID::exp_067_env_3_sustain, "Envelope 3 Sustain", Ctrl_Type::knob, Knob_Editor_Type::unsigned_7_bit,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			ID::exp_068_env_3_release, "Envelope 3 Release", Ctrl_Type::knob, Knob_Editor_Type::unsigned_7_bit,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			ID::exp_069_env_3_repeat, "Envelope 3 Repeat", Ctrl_Type::toggle, Knob_Editor_Type::none,
	...
	for (int mod = 0; mod < 4; ++mod) {
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				Ctrl_Type::cbox, Knob_Editor_Type::none, 65 + offset, EXP::choice_count_mod_src, 0,
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				Ctrl_Type::knob, Knob_Editor_Type::signed_8_bit, 66 + offset, 255, 127,
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				Ctrl_Type::cbox, Knob_Editor_Type::none, 67 + offset, EXP::choice_count_mod_dest, 0,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			Knob_Editor_Type::signed_8_bit, 81, 255, 127, cc_col_2_x, cc_row_1_y, knob_diameter, knob_diameter,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			Knob_Editor_Type::none, 82, EXP::choice_count_mod_dest, 0, cc_col_1_x, cc_row_1_y,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			Knob_Editor_Type::signed_8_bit, 83, 255, 127, cc_col_2_x, cc_row_2_y, knob_diameter, knob_diameter,
			Tip_Exp::midi_mod_wheel_amt(), Choices_Exp::signed_8_bit_int(curt), Choices_Exp::signed_8_bit_int()
		),
		-1, nullptr);
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			Knob_Editor_Type::none, 84, EXP::choice_count_mod_dest, 0, cc_col_1_x, cc_row_2_y,
			cc_cbox_w, cbox_h, cc_dest_description, Choices_Exp::mod_dest(curt), Choices_Exp::mod_dest()
		),
		-1, nullptr);
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			ID::exp_086_breath_amt, "Breath Amount", Ctrl_Type::knob, Knob_Editor_Type::signed_8_bit,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			ID::exp_087_breath_dest, "Breath Destination", Ctrl_Type::cbox, Knob_Editor_Type::none,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			ID::exp_088_velocity_amt, "Note Velocity Amount", Ctrl_Type::knob, Knob_Editor_Type::signed_8_bit,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			ID::exp_089_velocity_dest, "Note Velocity Destination", Ctrl_Type::cbox, Knob_Editor_Type::none,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			ID::exp_090_pedal_amt, "Foot Pedal Amount", Ctrl_Type::knob, Knob_Editor_Type::signed_8_bit,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			ID::exp_091_pedal_dest, "Foot Pedal Destination", Ctrl_Type::cbox, Knob_Editor_Type::none,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			Knob_Editor_Type::osc_pitch, 111, choice_count_osc_pitch, 60, 1191, push_it_knob_row_y,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			Knob_Editor_Type::unsigned_7_bit, 112, 128, 100, 1239, push_it_knob_row_y,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			ID::exp_094_push_it_mode, "Push It! Switch Mode", Ctrl_Type::cbox, Knob_Editor_Type::none,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			ID::exp_095_clock_tempo, "Clock Tempo", Ctrl_Type::knob, Knob_Editor_Type::tempo,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			ID::exp_096_clock_div, "Clock Division", Ctrl_Type::cbox, Knob_Editor_Type::none,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			ID::exp_097_arp_mode, "Arpeggiator Mode", Ctrl_Type::cbox, Knob_Editor_Type::none,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			ID::exp_098_arpeg_on_off, "Arpeggiator On / Off", Ctrl_Type::toggle, Knob_Editor_Type::none,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			ID::exp_099_seq_trig_mode, "Sequencer Trigger Mode", Ctrl_Type::cbox, Knob_Editor_Type::none,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			ID::exp_100_seq_on_off, "Sequencer On / Off", Ctrl_Type::toggle, Knob_Editor_Type::none,
	...
	for (int track = 1; track < 5; ++track) {
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				Ctrl_Type::cbox, Knob_Editor_Type::none, 76 + track, 
	...
	for (int knob = 1; knob < 5; ++knob) {
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				Ctrl_Type::cbox, Knob_Editor_Type::none, 104 + knob, 169,
		...
		for (int step = 0; step < 16; ++step) {
			...
			tree.addChild(
				Subtree_Exposed_Info_P::build(
					...
					Knob_Editor_Type::none, 120 + track * 16 + step, track == 0 ? 128 : 127, 0,
	...
	for (int character = 0; character < VOICE::name_char_count; ++character) {
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				id, "Program Name Character " + c, Ctrl_Type::voice_name_char, Knob_Editor_Type::none,
...
const Knob_Editor_Type Tree_Exposed_Info_P::knob_editor_type_for(const int i) const {
	if (i < exp_param_count)
		return Knob_Editor_Type{ (int)param(i)[ID::exp_p_knob_editor_type] };
	return Knob_Editor_Type::error;
}
