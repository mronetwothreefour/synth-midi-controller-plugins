	...
	exposedParamsInfoTree{ ID::tree_ExposedParamsInfo }
{
	...
	exposedParamsInfoTree.addChild(
		ValueTree{ "ep_015", {
				...
				{ ID::property_ControlType, (int)ControlType::knob },
				{ ID::property_KnobValueRangeType, (int)KnobValueRangeType::pitchBend },
				{ ID::property_NRPN, 93 },
	...
	exposedParamsInfoTree.addChild(
		ValueTree{ "ep_020", {
				...
				{ ID::property_ControlType, (int)ControlType::knobForPitch },
				{ ID::property_KnobValueRangeType, (int)KnobValueRangeType::lpfFrequency },
				{ ID::property_NRPN, 15 },
	...
	for (uint8 lfoNum = 0; lfoNum != 4; ++lfoNum) {
		...
		exposedParamsInfoTree.addChild(
			ValueTree{ paramNumString, {
					...
					{ ID::property_ControlType, (int)ControlType::knob },
					{ ID::property_KnobValueRangeType, (int)KnobValueRangeType::lfoFrequency },
	...
	exposedParamsInfoTree.addChild(
		ValueTree{ "ep_095", {
				...
				{ ID::property_ControlType, (int)ControlType::knob },
				{ ID::property_KnobValueRangeType, (int)KnobValueRangeType::clockTempo },
				{ ID::property_NRPN, 91 },
