	...
	Tree_Exposed_Info_B{ EXP::exp_param_count }
{
	...
	for (auto osc = 1; osc < 3; ++osc) {
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				osc == 1 ? 1 : 6, Range_Type::unsigned_int, Knob_Display_Type::osc_pitch,
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				Range_Type::unsigned_int, Knob_Display_Type::none, osc == 1 ? 4 : 5,
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				Range_Type::unsigned_int, Knob_Display_Type::unsigned_int, 64,
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				osc == 1 ? 2 : 7, Range_Type::unsigned_int, Knob_Display_Type::unsigned_int,
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				osc == 1 ? 78 : 80, Range_Type::signed_7_bit, Knob_Display_Type::signed_7_bit,
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				osc == 1 ? 79 : 81, Range_Type::signed_7_bit, Knob_Display_Type::signed_7_bit,
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				osc == 1 ? 14 : 16, Range_Type::unsigned_int, Knob_Display_Type::none,
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				osc == 1 ? 13 : 15, Range_Type::unsigned_int, Knob_Display_Type::none,
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				osc == 1 ? 4 : 9, Range_Type::unsigned_int, Knob_Display_Type::none,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			12, Range_Type::unsigned_int, Knob_Display_Type::unsigned_int,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			Range_Type::unsigned_int, Knob_Display_Type::unsigned_int, 128, 55,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			Range_Type::unsigned_int, Knob_Display_Type::unsigned_int, 64, 0,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			82, Range_Type::signed_7_bit, Knob_Display_Type::signed_7_bit, 127, 105,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			83, Range_Type::signed_7_bit, Knob_Display_Type::signed_7_bit, 127, 63,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			20, Range_Type::unsigned_int, Knob_Display_Type::none, 4, 0,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			21, Range_Type::unsigned_int, Knob_Display_Type::none, 3, 2,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			23, Range_Type::unsigned_int, Knob_Display_Type::unsigned_int, 64, 63,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			84, Range_Type::signed_7_bit, Knob_Display_Type::signed_7_bit, 127, 63,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			85, Range_Type::signed_7_bit, Knob_Display_Type::signed_7_bit, 127, 126,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			22, Range_Type::unsigned_int, Knob_Display_Type::unsigned_int, 64, 0,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			92, Range_Type::signed_7_bit, Knob_Display_Type::signed_7_bit, 127, 63,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			93, Range_Type::signed_7_bit, Knob_Display_Type::signed_7_bit, 127, 63,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			24, Range_Type::unsigned_int, Knob_Display_Type::unsigned_int, 64, 0,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			91, Range_Type::signed_7_bit, Knob_Display_Type::signed_7_bit, 127, 63,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			25, Range_Type::unsigned_int, Knob_Display_Type::none, 3, 0,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			26, Range_Type::unsigned_int, Knob_Display_Type::none, 2, 0,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			0, Range_Type::unsigned_int, Knob_Display_Type::none, 4, 0,
	...
	for (int lfo = 1; lfo < 3; ++lfo) {
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				Range_Type::unsigned_int, Knob_Display_Type::none, 7, 0,
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				Range_Type::unsigned_int, Knob_Display_Type::none, 21, 9,
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				lfo == 1 ? 94 : 95, Range_Type::signed_7_bit, Knob_Display_Type::signed_7_bit,
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				lfo == 1 ? 89 : 90, Range_Type::signed_7_bit, Knob_Display_Type::signed_7_bit,
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				Range_Type::unsigned_int, Knob_Display_Type::none, 4, 0,
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				Range_Type::unsigned_int, Knob_Display_Type::none, 2, 0,
	...
	for (int pt = 1; pt < 6; ++pt) {
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				Ctrl_Type::slider, 68 + pt, Range_Type::unsigned_int, Knob_Display_Type::unsigned_int, 64,
	...
	for (int env = 0; env < 3; ++env) {
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				Range_Type::unsigned_int, Knob_Display_Type::unsigned_int, 64, 40,
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				Range_Type::signed_7_bit, Knob_Display_Type::signed_7_bit, 127, 126,
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				Range_Type::unsigned_int, Knob_Display_Type::none, 8, 0,
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				Range_Type::unsigned_int, Knob_Display_Type::none, 3, 0,
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				Range_Type::unsigned_int, Knob_Display_Type::unsigned_int, 64, env == 2 ? 20 : 10,
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				Range_Type::unsigned_int, Knob_Display_Type::unsigned_int, 64, env == 2 ? 0 : 50,
