...
namespace XYWH
{
	...
	static const int ctrl_row_1_y{ 103 };
	static const int ctrl_row_2_y{ ctrl_row_1_y + ctrl_row_h };
	static const int ctrl_row_3_y{ ctrl_row_2_y + ctrl_row_h };

	static const int editor_init_w{ 1176 }, editor_init_h{ 540 };

	static const int env_knob_spacing{ 68 };
	static const int env_knob_a_x{ 559 };
	static const int env_knob_d_x{ env_knob_a_x + env_knob_spacing };
	static const int env_knob_s_x{ env_knob_d_x + env_knob_spacing };
	static const int env_knob_r_x{ env_knob_s_x + env_knob_spacing };

	static const int knob_diam{ 34 };
	static const int knob_diam_lpf_freq{ 50 };

	static const int switch_h{ 52 };
	static const int switch_lpf_type_h{ 84 };
