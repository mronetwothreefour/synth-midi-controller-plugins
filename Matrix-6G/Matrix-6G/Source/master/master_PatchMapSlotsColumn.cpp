...
PatchMapSlotsColumn::PatchMapSlotsColumn(UnexposedParameters* unexposedParams, uint8 firstProgramNumber) :
    ...
    slot_1{ unexposedParams, static_cast<uint8>(firstProgramNumber + 1) },
    slot_2{ unexposedParams, static_cast<uint8>(firstProgramNumber + 2) },
    slot_3{ unexposedParams, static_cast<uint8>(firstProgramNumber + 3) },
    slot_4{ unexposedParams, static_cast<uint8>(firstProgramNumber + 4) },
    slot_5{ unexposedParams, static_cast<uint8>(firstProgramNumber + 5) },
    slot_6{ unexposedParams, static_cast<uint8>(firstProgramNumber + 6) },
    slot_7{ unexposedParams, static_cast<uint8>(firstProgramNumber + 7) },
    slot_8{ unexposedParams, static_cast<uint8>(firstProgramNumber + 8) },
    slot_9{ unexposedParams, static_cast<uint8>(firstProgramNumber + 9) }
{
