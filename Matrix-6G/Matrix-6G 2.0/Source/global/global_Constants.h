...
namespace constants
{
	namespace global
	{
		...
		static const uint8 indexOfFirstGlobalDataByte{ 7 };
		...
		static const uint16 indexOfGlobalTuneLSByte{ indexOfVibratoAmplitudeModAmountLSByte + 2 };
		static const uint16 indexOfVelocityScaleTypeLSByte_Unused{ indexOfGlobalTuneLSByte + 2 };
