...
String Tip_Exposed_P::env_decay(bool vca) {
...
String Tip_Exposed_P::env_release(bool vca) {
...
String Tip_Exposed_P::env_sustain(bool vca) {
...
String Tip_Exposed_P::lpf_key_track() {
    return from_string_literal(SL::lpf_key_track_tip);
}

String Tip_Exposed_P::level_knob(const int k) {
...
String Tip_Exposed_P::osc_pitch_fine(const String o) {
...
String Tip_Exposed_P::osc_shape(const String o) {
...
String Tip_Exposed_P::osc_wave(const String o) {
...
String Tip_Exposed_P::voice_mode_depth() {
