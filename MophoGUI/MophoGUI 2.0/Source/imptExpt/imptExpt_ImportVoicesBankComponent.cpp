...
ImportVoicesBankComponent::ImportVoicesBankComponent(VoicesBank bank, VoiceSlotsComponent* slotsComponent, UnexposedParameters* unexposedParams) :
	BaseImportExportComponent{ ImptExptType::importVoicesBank, bank, slotsComponent, unexposedParams }
{
