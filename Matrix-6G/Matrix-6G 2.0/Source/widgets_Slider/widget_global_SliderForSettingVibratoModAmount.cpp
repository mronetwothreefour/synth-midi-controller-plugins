#include "widget_global_SliderForSettingVibratoModAmount.h"
	...
	propertyID{ propertyID }
{
	...
	auto paramValue{ propertyID == ID::global_VibratoAmplitudeModAmount ? globalOptions->vibratoAmplitudeModAmount() : globalOptions->vibratoSpeedModAmount() };
