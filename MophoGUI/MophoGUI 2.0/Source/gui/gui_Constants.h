...
namespace constants
{
	namespace GUI
	{
		...
		static const int randomizationUnlockAllButton_x{ randomizationLockAllButton_x + randomizationButtons_w + randomizationHorizGapBtwnLockIcons };
		...
		static const int randomizationAllowedNotesForSeqTrackComponent_x{ 391 };
		...
		static const int randomizationAllowedOctavesForLFOandSeqTrackComponents_w{ 124 };
		static const int randomizationAllowedOctavesForLFOcomponent_x{ 474 };
		static const int randomizationAllowedOctavesForLFOcomponent_y{ 313 };
		static const int randomizationAllowedOctavesForOsc1Component_x{ 486 };
		static const int randomizationAllowedOctavesForOsc2Component_x{ 662 };
		static const int randomizationAllowedOctavesForOscComponents_y{ 338 };
		static const int randomizationAllowedOctavesForOscComponent_h{ 91 };
		static const int randomizationAllowedOctavesForOscComponent_w{ 124 };
		static const int randomizationAllowedOctavesForSeqTrackComponent_x{ 737 };
		...
		static const int randomizationAllowedStepValuesForSeqTrackComponent_x{ 751 };
		...
		static const int randomizationAllowedSyncedFreqForLFOComponent_y{ 284 };
		...
		static const int randomizationAllowedUnsyncedFreqForLFOComponent_x{ 652 };
		static const int randomizationAllowedUnsyncedFreqForLFOComponent_y{ 283 };
		static const int randomizationAllowFreqCategoryToggles_y{ 259 };
		static const int randomizationAllowPitchedFreqToggle_x{ 416 };
		...
		static const int randomizationEditModeForSeqTrackComponent_x{ 401 };
		...
		static const int randomizationLFO1optionsShowButton_x{ randomizationLFO1unlockButton_x + randomizationLockAndUnlockButtons_w + randomizationHorizGapBtwnLockIcons };
		...
		static const int randomizationLFO2optionsShowButton_x{ randomizationLFO1optionsShowButton_x + lfoControlsHorizontalSpacing };
		...
		static const int randomizationLFO3optionsShowButton_x{ randomizationLFO2optionsShowButton_x + lfoControlsHorizontalSpacing };
		...
		static const int randomizationLFO4optionsShowButton_x{ randomizationLFO3optionsShowButton_x + lfoControlsHorizontalSpacing };
		static const int randomizationLFOoptionsShowButtons_y{ 476 };
		...
		static const int randomizationOptionsComponent_ValueRange_x{ 559 };
		static const int randomizationOptionsComponent_ValueRange_y{ 244 };
		static const int randomizationOptionsComponent_ValueRange_CloseButton_x{ 602 };
		static const int randomizationOptionsComponent_ValueRange_CloseButton_y{ 343 };
		static const int randomizationOptionsComponent_ValueRange_Knobs_y{ 284 };
		static const int randomizationOptionsComponent_ValueRange_MinKnob_x{ 576 };
		static const int randomizationOptionsComponent_ValueRange_MaxKnob_x{ 637 };
		static const int randomizationSeqTrackComponentRow1_y{ 319 };
		static const int randomizationSeqTrackComponentRow2_y{ 354 };
		static const int randomizationSeqTrackOptionsBackground_x{ 252 };
		static const int randomizationSeqTrackOptionsBackground_y{ 181 };
		...
		static const int randomizationOscOptionsShowButton_x{ randomizationOscUnlockButton_x + randomizationLockAndUnlockButtons_w + randomizationHorizGapBtwnLockIcons };
		static const int randomizationOscOptionsShowButton_y{ 11 };
		static const int randomizationLFOoptionsCloseButton_x{ 915 };
		static const int randomizationLFOoptionsCloseButton_y{ 233 };
		static const int randomizationOscOptionsCloseButton_x{ 611 };
		static const int randomizationOscOptionsCloseButton_y{ 432 };
		...
		static const int randomizationProbabilitiesForSeqTrack1Component_x{ 544 };
		static const int randomizationProbabilitiesForSeqTracks2_3_4Component_w{ 100 };
		static const int randomizationProbabilitiesForSeqTracks2_3_4Component_x{ 574 };
		...
		static const int randomizationSettingsGearIcon_diameter{ 18 };
		...
		static const int randomizationSeqTrackOptionsCloseButton_x{ 811 };
		static const int randomizationSeqTrackOptionsCloseButton_y{ 196 };
		...
		static const Rectangle<int> bounds_RandomizationAllowedNotesForLFO{ randomizationAllowedNotesForLFOComponent_x, randomizationAllowedNotesForLFOComponent_y, randomizationAllowedNotesComponent_w, randomizationAllowedNotesComponent_h };
		...
		static const Rectangle<int> bounds_RandomizationAllowedNotesForSeqTrack{ randomizationAllowedNotesForSeqTrackComponent_x, randomizationSeqTrackComponentRow2_y, randomizationAllowedNotesForSeqTrackComponent_w, randomizationAllowedNotesComponent_h };
		static const Rectangle<int> bounds_RandomizationAllowedOctavesForLFO{ randomizationAllowedOctavesForLFOComponent_x, randomizationAllowedOctavesForLFOComponent_y, randomizationAllowedOctavesForLFOandSeqTrackComponents_w, randomizationAllowedOctavesForLFOandSeqTrackComponents_h };
		...
		static const Rectangle<int> bounds_RandomizationAllowedOctavesForOsc2{ randomizationAllowedOctavesForOsc2Component_x, randomizationAllowedOctavesForOscComponents_y, randomizationAllowedOctavesForOscComponent_w, randomizationAllowedOctavesForOscComponent_h };
		static const Rectangle<int> bounds_RandomizationAllowedOctavesForSeqTrack{ randomizationAllowedOctavesForSeqTrackComponent_x, randomizationSeqTrackComponentRow2_y, randomizationAllowedOctavesForLFOandSeqTrackComponents_w, randomizationAllowedOctavesForLFOandSeqTrackComponents_h };
		static const Rectangle<int> bounds_RandomizationAllowedStepValuesForSeqTrack{ randomizationAllowedStepValuesForSeqTrackComponent_x, randomizationSeqTrackComponentRow1_y, randomizationAllowedStepValuesForSeqTrackComponent_w, randomizationAllowedStepValuesForSeqTrackComponent_h };
		static const Rectangle<int> bounds_RandomizationAllowedSyncedFreqForLFO{ randomizationAllowedSyncedFreqForLFOComponent_x, randomizationAllowedSyncedFreqForLFOComponent_y, randomizationAllowedSyncedFreqForLFOComponent_w, randomizationAllowedSyncedFreqForLFOComponent_h };
		static const Rectangle<int> bounds_RandomizationAllowedUnsyncedFreqForLFO{ randomizationAllowedUnsyncedFreqForLFOComponent_x, randomizationAllowedUnsyncedFreqForLFOComponent_y, randomizationAllowedUnsyncedFreqForLFOComponent_w, randomizationAllowedUnsyncedFreqForLFOComponent_h };
		static const Rectangle<int> bounds_RandomizationAllowPitchedFreqToggle{ randomizationAllowPitchedFreqToggle_x, randomizationAllowFreqCategoryToggles_y, toggle_diameter, toggle_diameter };
		static const Rectangle<int> bounds_RandomizationAllowSyncedFreqToggle{ randomizationAllowSyncedFreqToggle_x, randomizationAllowFreqCategoryToggles_y, toggle_diameter, toggle_diameter };
		static const Rectangle<int> bounds_RandomizationAllowUnsyncedFreqToggle{ randomizationAllowUnsyncedFreqToggle_x, randomizationAllowFreqCategoryToggles_y, toggle_diameter, toggle_diameter };
		...
		static const Rectangle<int> bounds_RandomizationEditModeForSeqTrack{ randomizationEditModeForSeqTrackComponent_x, randomizationSeqTrackComponentRow1_y, randomizationEditModeForSeqTrackComponent_w, randomizationEditModeForSeqTrackComponent_h };
		...
		static const Rectangle<int> bounds_RandomizationLFO1optionsShowButton{ randomizationLFO1optionsShowButton_x, randomizationLFOoptionsShowButtons_y, randomizationSettingsGearIcon_diameter, randomizationSettingsGearIcon_diameter };
		...
		static const Rectangle<int> bounds_RandomizationLFO2optionsShowButton{ randomizationLFO2optionsShowButton_x, randomizationLFOoptionsShowButtons_y, randomizationSettingsGearIcon_diameter, randomizationSettingsGearIcon_diameter };
		...
		static const Rectangle<int> bounds_RandomizationLFO3optionsShowButton{ randomizationLFO3optionsShowButton_x, randomizationLFOoptionsShowButtons_y, randomizationSettingsGearIcon_diameter, randomizationSettingsGearIcon_diameter };
		...
		static const Rectangle<int> bounds_RandomizationLFO4optionsShowButton{ randomizationLFO4optionsShowButton_x, randomizationLFOoptionsShowButtons_y, randomizationSettingsGearIcon_diameter, randomizationSettingsGearIcon_diameter };
		static const Rectangle<int> bounds_RandomizationLFOoptionsCloseButton{ randomizationLFOoptionsCloseButton_x, randomizationLFOoptionsCloseButton_y, secondaryWindowsControls_w, secondaryWindowsControls_h };
		...
		static const Rectangle<int> bounds_RandomizationOptions_ValueRange_CloseButton{ randomizationOptionsComponent_ValueRange_CloseButton_x, randomizationOptionsComponent_ValueRange_CloseButton_y, secondaryWindowsControls_w, secondaryWindowsControls_h };
		static const Rectangle<int> bounds_RandomizationOptions_ValueRange_MinKnob{ randomizationOptionsComponent_ValueRange_MinKnob_x, randomizationOptionsComponent_ValueRange_Knobs_y, knob_diameter, knob_diameter };
		static const Rectangle<int> bounds_RandomizationOptions_ValueRange_MaxKnob{ randomizationOptionsComponent_ValueRange_MaxKnob_x, randomizationOptionsComponent_ValueRange_Knobs_y, knob_diameter, knob_diameter };
		...
		static const Rectangle<int> bounds_RandomizationOscOptionsCloseButton{ randomizationOscOptionsCloseButton_x, randomizationOscOptionsCloseButton_y, secondaryWindowsControls_w, secondaryWindowsControls_h };
		static const Rectangle<int> bounds_RandomizationOscOptionsShowButton{ randomizationOscOptionsShowButton_x, randomizationOscOptionsShowButton_y, randomizationSettingsGearIcon_diameter, randomizationSettingsGearIcon_diameter };
		static const Rectangle<int> bounds_RandomizationProbabilitiesForSeqTrack1{ randomizationProbabilitiesForSeqTrack1Component_x, randomizationSeqTrackComponentRow1_y, randomizationProbabilitiesForSeqTrack1Component_w, randomizationProbabilitiesForSeqTrackComponent_h };
		static const Rectangle<int> bounds_RandomizationProbabilitiesForSeqTrack2_3_4{ randomizationProbabilitiesForSeqTracks2_3_4Component_x, randomizationSeqTrackComponentRow1_y, randomizationProbabilitiesForSeqTracks2_3_4Component_w, randomizationProbabilitiesForSeqTrackComponent_h };
