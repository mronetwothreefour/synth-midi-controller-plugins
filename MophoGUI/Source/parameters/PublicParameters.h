...
public:
	...
	ParamLayout createLayout()
	{
		...
		/*49 */layout.add(std::make_unique<AudioParameterChoice>	(ID::lfo2Destination.toString(),	"LFO 2 Destination", choices.modDestination, 0));
		...
		/*54 */layout.add(std::make_unique<AudioParameterChoice>	(ID::lfo3Destination.toString(),	"LFO 3 Destination", choices.modDestination, 0));
		...
		/*59 */layout.add(std::make_unique<AudioParameterChoice>	(ID::lfo4Destination.toString(),	"LFO 4 Destination", choices.modDestination, 0));
