...
namespace ID
{
	...
	static const Identifier param000_osc1_Pitch{ "param000_osc1_Pitch" };
	static const Identifier param001_osc1_Fine{ "param001_osc1_Fine" };
	static const Identifier param002_osc1_Shape{ "param002_osc1_Shape" };
	static const Identifier param003_osc1_Glide{ "param003_osc1_Glide" };
	static const Identifier param004_osc1_KeyTrack{ "param004_osc1_KeyTrack" };
	static const Identifier param005_osc1_SubLevel{ "param005_osc1_SubLevel" };
	static const Identifier param006_osc2_Pitch{ "param006_osc2_Pitch" };
	static const Identifier param007_osc2_Fine{ "param007_osc2_Fine" };
	static const Identifier param008_osc2_Shape{ "param008_osc2_Shape" };
	static const Identifier param009_osc2_Glide{ "param009_osc2_Glide" };
	static const Identifier param010_osc2_KeyTrack{ "param010_osc2_KeyTrack" };
	static const Identifier param011_osc2_SubLevel{ "param011_osc2_SubLevel" };
	static const Identifier param012_oscSync{ "param012_oscSync" };
	static const Identifier param013_glideMode{ "param013_glideMode" };
	static const Identifier param014_oscSlop{ "param014_oscSlop" };
	static const Identifier param015_bendRange{ "param015_bendRange" };
	static const Identifier param016_notePriority{ "param016_notePriority" };
	static const Identifier param017_oscMix{ "param017_oscMix" };
	static const Identifier param018_noiseLevel{ "param018_noiseLevel" };
	static const Identifier param019_extInLevel{ "param019_extInLevel" };
	static const Identifier param020_lpfFreq{ "param020_lpfFreq" };
	static const Identifier param021_lpfReso{ "param021_lpfReso" };
	static const Identifier param022_lpfKeyAmount{ "param022_lpfKeyAmount" };
	static const Identifier param023_lpfFMamount{ "param023_lpfFMamount" };
	static const Identifier param024_lpfType{ "param024_lpfType" };
	static const Identifier param025_lpfEnvAmount{ "param025_lpfEnvAmount" };
	static const Identifier param026_lpfVelAmount{ "param026_lpfVelAmount" };
	static const Identifier param027_lpfDelay{ "param027_lpfDelay" };
	static const Identifier param028_lpfAttack{ "param028_lpfAttack" };
	...
	static const Identifier param104_SeqTrack4Dest{ "param104_SeqTrack4Dest" };
