...
void Draw_Paths_Widgets_P::wave_pulse(Graphics& g, const int w, float& scale_factor) {
	Path p;
...
void Draw_Paths_Widgets_P::wave_saw(Graphics& g, float& scale_factor) {
	Path p;
...
void Draw_Paths_Widgets_P::wave_saw_tri(Graphics& g, float& scale_factor) {
	Path p;
...
PathStrokeType Draw_Paths_Widgets_P::wave_stroke() {
	return { 1.0f, PathStrokeType::mitered, PathStrokeType::rounded };
}

void Draw_Paths_Widgets_P::wave_tri(Graphics& g, float& scale_factor) {
	Path p;
