...
const StringArray Build_Choices::exp_env_mode() {
	StringArray list;
...
const StringArray Build_Choices::exp_env_trig_mode() {
	StringArray list;
...
const StringArray Build_Choices::exp_env_lfo_1_trig() {
	StringArray list;
...
const StringArray Build_Choices::exp_keyboard_mode() {
	StringArray list;
...
const StringArray Build_Choices::exp_lever_ctrl() {
	StringArray list;
	list.add("OFF__off");
...
const StringArray Build_Choices::exp_lfo_trig_mode() {
	StringArray list;
...
const StringArray Build_Choices::exp_lfo_wave_type() {
	StringArray list;
...
const StringArray Build_Choices::exp_input_source(bool for_lfo) {
	StringArray list;
	list.add("NONE__none");
...
const StringArray Build_Choices::exp_off_on_matrix() {
	return { "OFF__off", "ON__on" };
}

const StringArray Build_Choices::exp_osc_1_key_track() {
	StringArray list;
...
const StringArray Build_Choices::exp_osc_1_sync() {
	StringArray list;
	list.add("OFF__off (0)");
...
const StringArray Build_Choices::exp_osc_2_and_vcf_key_track() {
	StringArray list;
...
const StringArray Build_Choices::exp_osc_lever_control() {
	StringArray list;
	list.add("OFF__off");
	list.add("BEND__pitch bend by lever 1");
	list.add("VIB__vibrato by lever 2");
...
const StringArray Build_Choices::exp_osc_type(const int o) {
	StringArray list;
	list.add("OFF__off");
...
const StringArray Build_Choices::exp_porta_mode() {
	StringArray list;
...
const StringArray Build_Choices::exp_ramp_trig() {
	StringArray list;
	list.add("STRIG__single trigger");
	list.add("MTRIG__multiple trigger");
	list.add("XTRIG__external single trigger");
