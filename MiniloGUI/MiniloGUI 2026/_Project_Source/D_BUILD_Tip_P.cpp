...
String Build_Tip::exp_env_decay(bool vca) {
...
String Build_Tip::exp_env_release(bool vca) {
...
String Build_Tip::exp_env_sustain(bool vca) {
...
String Build_Tip::exp_lpf_key_track() {
    return from_string_literal(SL::lpf_key_track_tip);
}

String Build_Tip::exp_level_knob(const int k) {
...
String Build_Tip::exp_osc_pitch_fine(const int o) {
...
String Build_Tip::exp_osc_wave(const int o) {
...
String Build_Tip::exp_voice_mode_depth() {
