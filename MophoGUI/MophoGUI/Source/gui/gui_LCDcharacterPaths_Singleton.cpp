...
Path LCDcharacterPaths::createPathForChar33_ExclamationPoint() {
	Path path;
	path.loadPathFromData(GUI::pathDataForPixel_Row1Col3.data(), GUI::pathDataForPixel_Row1Col3.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row2Col3.data(), GUI::pathDataForPixel_Row2Col3.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row3Col3.data(), GUI::pathDataForPixel_Row3Col3.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row4Col3.data(), GUI::pathDataForPixel_Row4Col3.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row7Col3.data(), GUI::pathDataForPixel_Row7Col3.size());
	return path;
}

Path LCDcharacterPaths::createPathForChar34_DoubleQuote() {
	Path path;
	path.loadPathFromData(GUI::pathDataForPixel_Row1Col2.data(), GUI::pathDataForPixel_Row1Col2.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row1Col4.data(), GUI::pathDataForPixel_Row1Col4.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row2Col2.data(), GUI::pathDataForPixel_Row2Col2.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row2Col4.data(), GUI::pathDataForPixel_Row2Col4.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row3Col2.data(), GUI::pathDataForPixel_Row3Col2.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row3Col4.data(), GUI::pathDataForPixel_Row3Col4.size());
	return path;
}
...
Path LCDcharacterPaths::createPathForChar35_HashSymbol() {
	...
	path.loadPathFromData(GUI::pathDataForPixel_Row2Col2.data(), GUI::pathDataForPixel_Row2Col2.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row2Col4.data(), GUI::pathDataForPixel_Row2Col4.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row3Col1.data(), GUI::pathDataForPixel_Row3Col1.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row3Col2.data(), GUI::pathDataForPixel_Row3Col2.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row3Col3.data(), GUI::pathDataForPixel_Row3Col3.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row3Col4.data(), GUI::pathDataForPixel_Row3Col4.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row3Col5.data(), GUI::pathDataForPixel_Row3Col5.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row4Col2.data(), GUI::pathDataForPixel_Row4Col2.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row4Col4.data(), GUI::pathDataForPixel_Row4Col4.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row5Col1.data(), GUI::pathDataForPixel_Row5Col1.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row5Col2.data(), GUI::pathDataForPixel_Row5Col2.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row5Col3.data(), GUI::pathDataForPixel_Row5Col3.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row5Col4.data(), GUI::pathDataForPixel_Row5Col4.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row5Col5.data(), GUI::pathDataForPixel_Row5Col5.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row6Col2.data(), GUI::pathDataForPixel_Row6Col2.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row6Col4.data(), GUI::pathDataForPixel_Row6Col4.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row7Col2.data(), GUI::pathDataForPixel_Row7Col2.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row7Col4.data(), GUI::pathDataForPixel_Row7Col4.size());
	return path;
}
...
Path LCDcharacterPaths::createPathForChar36_$() {
	...
	path.loadPathFromData(GUI::pathDataForPixel_Row2Col3.data(), GUI::pathDataForPixel_Row2Col3.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row2Col4.data(), GUI::pathDataForPixel_Row2Col4.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row2Col5.data(), GUI::pathDataForPixel_Row2Col5.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row3Col1.data(), GUI::pathDataForPixel_Row3Col1.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row3Col3.data(), GUI::pathDataForPixel_Row3Col3.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row4Col2.data(), GUI::pathDataForPixel_Row4Col2.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row4Col3.data(), GUI::pathDataForPixel_Row4Col3.size());
	...
	path.loadPathFromData(GUI::pathDataForPixel_Row5Col3.data(), GUI::pathDataForPixel_Row5Col3.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row5Col5.data(), GUI::pathDataForPixel_Row5Col5.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row6Col1.data(), GUI::pathDataForPixel_Row6Col1.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row6Col2.data(), GUI::pathDataForPixel_Row6Col2.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row6Col3.data(), GUI::pathDataForPixel_Row6Col3.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row6Col4.data(), GUI::pathDataForPixel_Row6Col4.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row7Col3.data(), GUI::pathDataForPixel_Row7Col3.size());
	return path;
}
...
Path LCDcharacterPaths::createPathForChar37_PercentageSymbol() {
	Path path;
	path.loadPathFromData(GUI::pathDataForPixel_Row1Col1.data(), GUI::pathDataForPixel_Row1Col1.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row1Col2.data(), GUI::pathDataForPixel_Row1Col2.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row2Col1.data(), GUI::pathDataForPixel_Row2Col1.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row2Col2.data(), GUI::pathDataForPixel_Row2Col2.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row2Col5.data(), GUI::pathDataForPixel_Row2Col5.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row3Col4.data(), GUI::pathDataForPixel_Row3Col4.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row4Col3.data(), GUI::pathDataForPixel_Row4Col3.size());
	...
	path.loadPathFromData(GUI::pathDataForPixel_Row6Col1.data(), GUI::pathDataForPixel_Row6Col1.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row6Col4.data(), GUI::pathDataForPixel_Row6Col4.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row6Col5.data(), GUI::pathDataForPixel_Row6Col5.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row7Col4.data(), GUI::pathDataForPixel_Row7Col4.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row7Col5.data(), GUI::pathDataForPixel_Row7Col5.size());
	return path;
}
...
Path LCDcharacterPaths::createPathForChar43_PlusSymbol() {
	...
	path.loadPathFromData(GUI::pathDataForPixel_Row2Col3.data(), GUI::pathDataForPixel_Row2Col3.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row3Col3.data(), GUI::pathDataForPixel_Row3Col3.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row4Col1.data(), GUI::pathDataForPixel_Row4Col1.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row4Col2.data(), GUI::pathDataForPixel_Row4Col2.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row4Col3.data(), GUI::pathDataForPixel_Row4Col3.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row4Col4.data(), GUI::pathDataForPixel_Row4Col4.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row4Col5.data(), GUI::pathDataForPixel_Row4Col5.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row5Col3.data(), GUI::pathDataForPixel_Row5Col3.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row6Col3.data(), GUI::pathDataForPixel_Row6Col3.size());
	return path;
}
...
Path LCDcharacterPaths::createPathForChar50_2() {
	...
	path.loadPathFromData(GUI::pathDataForPixel_Row5Col3.data(), GUI::pathDataForPixel_Row5Col3.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row6Col2.data(), GUI::pathDataForPixel_Row6Col2.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row7Col1.data(), GUI::pathDataForPixel_Row7Col1.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row7Col2.data(), GUI::pathDataForPixel_Row7Col2.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row7Col3.data(), GUI::pathDataForPixel_Row7Col3.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row7Col4.data(), GUI::pathDataForPixel_Row7Col4.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row7Col5.data(), GUI::pathDataForPixel_Row7Col5.size());
...
Path LCDcharacterPaths::createPathForChar51_3() {
	...
	path.loadPathFromData(GUI::pathDataForPixel_Row1Col3.data(), GUI::pathDataForPixel_Row1Col3.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row1Col4.data(), GUI::pathDataForPixel_Row1Col4.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row1Col5.data(), GUI::pathDataForPixel_Row1Col5.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row2Col4.data(), GUI::pathDataForPixel_Row2Col4.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row3Col3.data(), GUI::pathDataForPixel_Row3Col3.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row4Col4.data(), GUI::pathDataForPixel_Row4Col4.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row5Col5.data(), GUI::pathDataForPixel_Row5Col5.size());
...
Path LCDcharacterPaths::createPathForChar66_B()
{
	...
	path.loadPathFromData(GUI::pathDataForPixel_Row1Col3.data(), GUI::pathDataForPixel_Row1Col3.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row1Col4.data(), GUI::pathDataForPixel_Row1Col4.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row2Col1.data(), GUI::pathDataForPixel_Row1Col1.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row2Col5.data(), GUI::pathDataForPixel_Row1Col1.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row3Col1.data(), GUI::pathDataForPixel_Row1Col1.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row3Col5.data(), GUI::pathDataForPixel_Row1Col1.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row4Col1.data(), GUI::pathDataForPixel_Row1Col1.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row4Col2.data(), GUI::pathDataForPixel_Row1Col2.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row4Col3.data(), GUI::pathDataForPixel_Row1Col3.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row4Col4.data(), GUI::pathDataForPixel_Row1Col4.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row5Col1.data(), GUI::pathDataForPixel_Row1Col1.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row5Col5.data(), GUI::pathDataForPixel_Row1Col1.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row6Col1.data(), GUI::pathDataForPixel_Row1Col1.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row6Col5.data(), GUI::pathDataForPixel_Row1Col1.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row7Col1.data(), GUI::pathDataForPixel_Row1Col1.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row7Col2.data(), GUI::pathDataForPixel_Row1Col2.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row7Col3.data(), GUI::pathDataForPixel_Row1Col3.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row7Col4.data(), GUI::pathDataForPixel_Row1Col4.size());
	return path;
}
...
Path LCDcharacterPaths::createPathForChar85_U() {
	...
	path.loadPathFromData(GUI::pathDataForPixel_Row4Col1.data(), GUI::pathDataForPixel_Row4Col1.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row4Col5.data(), GUI::pathDataForPixel_Row4Col5.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row5Col1.data(), GUI::pathDataForPixel_Row5Col5.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row5Col5.data(), GUI::pathDataForPixel_Row5Col5.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row6Col1.data(), GUI::pathDataForPixel_Row6Col1.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row6Col5.data(), GUI::pathDataForPixel_Row6Col5.size());
	path.loadPathFromData(GUI::pathDataForPixel_Row7Col2.data(), GUI::pathDataForPixel_Row7Col2.size());
