	...
	Tree_Exposed_Info_B{ EXP::exp_param_count }
{
	...
	for (auto osc = 1; osc < 3; ++osc) {
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				"Oscillator " + o + " Octave", Ctrl_Type::switch_osc_octave, Knob_Editor_Type::none,
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				"Oscillator " + o + " Wave", Ctrl_Type::switch_3_pole, Knob_Editor_Type::none,
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				Knob_Editor_Type::osc_pitch_fine, osc == 1 ? 34 : 35, EXP::choice_count_unsigned_10_bit,
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				"Oscillator " + o + " Shape",  Ctrl_Type::knob, Knob_Editor_Type::unsigned_10_bit,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			Knob_Editor_Type::osc_2_pitch_eg_int, 41, EXP::choice_count_unsigned_10_bit, 0,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			Knob_Editor_Type::osc_2_pitch_eg_int, 42, EXP::choice_count_unsigned_10_bit, 512,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			ID::exp_10_osc_2_sync, "Oscillator 2 Sync", Ctrl_Type::switch_2_pole, Knob_Editor_Type::none,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			Knob_Editor_Type::none, 81, 2, 0, 244, ctrl_row_3_y, switch_w, switch_h,
	...
	for (int knob = 1; knob < 4; ++knob) {
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				Ctrl_Type::knob, Knob_Editor_Type::unsigned_10_bit, knob == 1 ? 39 : knob == 2 ? 40 : 33,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			Knob_Editor_Type::unsigned_10_bit, 43, EXP::choice_count_unsigned_10_bit, 1023,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			ID::exp_16_lpf_reso, "LPF Resonance", Ctrl_Type::knob, Knob_Editor_Type::unsigned_10_bit,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			ID::exp_17_lpf_eg_int, "LPF EG Intensity", Ctrl_Type::knob, Knob_Editor_Type::unsigned_10_bit,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			Knob_Editor_Type::none, 84, 2, 1, 380, ctrl_row_3_y, switch_w, switch_h,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			Knob_Editor_Type::none, 83, 3, 0, 437, ctrl_row_3_y, 40, switch_h,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			Knob_Editor_Type::none, 82, 3, 0, 482, ctrl_row_3_y, 40, switch_h,
	...
	for (int env = 1; env < 3; ++env) {
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				pre + "Envelope Attack", Ctrl_Type::knob, Knob_Editor_Type::unsigned_10_bit,
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				pre + "Envelope Decay", Ctrl_Type::knob, Knob_Editor_Type::unsigned_10_bit,
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				pre + "Envelope Sustain", Ctrl_Type::knob, Knob_Editor_Type::unsigned_10_bit,
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				pre + "Envelope Release", Ctrl_Type::knob, Knob_Editor_Type::unsigned_10_bit,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			ID::exp_29_LFO_Wave, "LFO Wave", Ctrl_Type::switch_3_pole, Knob_Editor_Type::none,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			Knob_Editor_Type::none, 57, 3, 0, 585, ctrl_row_3_y, 40, switch_h,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			ID::exp_31_lfo_rate, "LFO Rate", Ctrl_Type::knob_lfo_rate, Knob_Editor_Type::lfo_rate,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			ID::exp_32_lfo_int, "LFO Intensity", Ctrl_Type::knob, Knob_Editor_Type::unsigned_10_bit,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			Knob_Editor_Type::none, 56, 3, 2, 769, ctrl_row_3_y, 50, switch_h,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			Knob_Editor_Type::unsigned_10_bit, 29, EXP::choice_count_unsigned_10_bit, 256,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			ID::exp_35_delay_time, "Delay Time", Ctrl_Type::knob, Knob_Editor_Type::unsigned_10_bit,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			ID::exp_36_delay_feedback, "Delay Feedback", Ctrl_Type::knob, Knob_Editor_Type::unsigned_10_bit,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			Knob_Editor_Type::none, 88, 3, 0, 1033, ctrl_row_1_y, 50, switch_h,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			Knob_Editor_Type::voice_mode_depth, 27, EXP::choice_count_unsigned_10_bit, 0,
