...
const StringArray Build_Choices::env_mode() {
	StringArray list;
...
const StringArray Build_Choices::env_trig_mode() {
	StringArray list;
...
const StringArray Build_Choices::env_lfo_1_trig() {
	StringArray list;
...
const StringArray Build_Choices::keyboard_mode() {
	StringArray list;
...
const StringArray Build_Choices::lever_ctrl() {
	StringArray list;
	list.add("OFF__off");
...
const StringArray Build_Choices::lfo_trig_mode() {
	StringArray list;
...
const StringArray Build_Choices::lfo_wave_type() {
	StringArray list;
...
const StringArray Build_Choices::input_source(bool for_lfo) {
	StringArray list;
	list.add("NONE__none");
...
const StringArray Build_Choices::off_on_matrix() {
	return { "OFF__off", "ON__on" };
}

const StringArray Build_Choices::osc_1_key_track() {
	StringArray list;
...
const StringArray Build_Choices::osc_1_sync() {
	StringArray list;
	list.add("OFF__off (0)");
...
const StringArray Build_Choices::osc_2_and_vcf_key_track() {
	StringArray list;
...
const StringArray Build_Choices::osc_type(const int o) {
	StringArray list;
	list.add("OFF__off");
...
const StringArray Build_Choices::porta_mode() {
	StringArray list;
...
const StringArray Build_Choices::ramp_trig() {
	StringArray list;
	list.add("STRIG__single trigger");
	list.add("MTRIG__multiple trigger");
	list.add("XTRIG__external single trigger");
