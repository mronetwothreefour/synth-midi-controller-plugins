...
String Tip_For::exp_env_3_repeat() {
...
String Tip_For::exp_ext_in_level() {
...
String Tip_For::exp_noise_level() {
    return from_string_literal(SL::noise_level_tip);
}

String Tip_For::exp_note_priority() {
...
String Tip_For::exp_voice_volume() {
