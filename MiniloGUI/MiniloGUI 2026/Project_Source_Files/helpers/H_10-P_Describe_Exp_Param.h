...
struct Describe_Exp_Param
{
	...
	static String lpf_velo_amt();

	static String osc_2_pitch_eg_int();
	static String osc_2_ring_mod();
	static String osc_2_sync();
	static String osc_2_x_mod_depth();
	static String osc_octave(const String osc_num);
	static String osc_pitch_fine(const String osc_num);
	static String osc_shape(const String osc_num);
	static String osc_wave(const String osc_num);
