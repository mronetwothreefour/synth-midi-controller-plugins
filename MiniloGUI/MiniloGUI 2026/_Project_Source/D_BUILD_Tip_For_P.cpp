...
String Tip_For::exp_delay_routing() {
    return from_string_literal(SL::delay_routing_tip);
}

String Tip_For::exp_delay_time() {
    return from_string_literal(SL::delay_time_tip);
}

String Tip_For::exp_delay_hpf_freq() {
...
String Tip_For::exp_lpf_key_track() {
...
String Tip_For::exp_voice_mode_depth() {
