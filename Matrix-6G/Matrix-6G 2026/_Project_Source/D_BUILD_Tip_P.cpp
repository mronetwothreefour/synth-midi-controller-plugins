...
String Build_Tip::exp_osc_lever_control(const int o) {
    return from_string_literal(SL::osc_lever_control_tip).replace("_", (String)o);
}

String Build_Tip::exp_osc_lfo_1_fm(const int o) {
    return from_string_literal(SL::osc_lfo_1_fm_tip).replace("_", (String)o);
}

String Build_Tip::exp_osc_lfo_2_pwm(const int o) {
...
String Build_Tip::exp_osc_pulse_w(const int o) {
    return from_string_literal(SL::osc_pulse_w_tip).replace("_", (String)o);
}

String Build_Tip::exp_osc_saw_tri(const int o) {
    return from_string_literal(SL::osc_saw_tri_tip).replace("_", (String)o);
}

String Build_Tip::exp_osc_type(const int o) {
