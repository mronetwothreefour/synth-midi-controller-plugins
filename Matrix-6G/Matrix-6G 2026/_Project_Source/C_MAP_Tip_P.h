...
namespace MAP
{
	...
	static const std::unordered_map<String, String> tip{
		...
		{ ID::exp_osc_2_detune, Tip_For::exp_osc_2_detune() },
		{ ID::exp_osc_2_lfo_1_fm, Tip_For::exp_osc_lfo_1_fm(1) },
		{ ID::exp_osc_2_lfo_2_pwm, Tip_For::exp_osc_lfo_2_pwm(1) },
		{ ID::exp_osc_2_key_click, Tip_For::exp_osc_key_click() },
		{ ID::exp_osc_2_key_track, Tip_For::exp_osc_key_track(1) },
		{ ID::exp_osc_2_lever_ctrl, Tip_For::exp_osc_lever_control(2) },
		{ ID::exp_osc_balance, Tip_For::exp_osc_balance() },
		//exposed vcf
		{ ID::exp_vcf_freq, Tip_For::exp_vcf_freq() },
		{ ID::exp_vcf_reso, Tip_For::exp_vcf_reso() },
		{ ID::exp_vcf_env_1_amt, Tip_For::exp_vcf_env_1_amt() },
		{ ID::exp_vcf_press_amt, Tip_For::exp_vcf_press_amt() },
		{ ID::exp_vcf_lever_ctrl, Tip_For::exp_vcf_lever_ctrl() },
		{ ID::exp_vcf_key_track, Tip_For::exp_vcf_key_track() },
		//exposed vca
		{ ID::exp_vca_1_volume, Tip_For::exp_vca_1_volume() },
		{ ID::exp_vca_1_velo_amt, Tip_For::exp_vca_1_velo_amt() },
		{ ID::exp_vca_2_env_2_amt, Tip_For::exp_vca_2_env_2_amt() },
		//exposed vcf fm
		{ ID::exp_vcf_fm_osc_1_amt, Tip_For::exp_vcf_fm_osc_1_amt() },
		{ ID::exp_vcf_fm_env_3_amt, Tip_For::exp_vcf_fm_env_3_amt() },
		{ ID::exp_vcf_fm_press_amt, Tip_For::exp_vcf_fm_press_amt() },
		//exposed porta & keyboard mode
		{ ID::exp_porta_rate, Tip_For::exp_porta_rate() },
		{ ID::exp_porta_velo, Tip_For::exp_porta_velo() },
		{ ID::exp_porta_mode, Tip_For::exp_porta_mode() },
		{ ID::exp_porta_legato, Tip_For::exp_porta_legato() },
		{ ID::exp_keyboard_mode, Tip_For::exp_keyboard_mode() },
		//exposed lfo
		...
		{ ID::exp_lfo_1_press_amt, Tip_For::exp_lfo_1_pressure_amt() },
		...
		{ ID::exp_lfo_2_key_track_amt, Tip_For::exp_lfo_2_key_track_amt() },
		...
		//exposed tracking
		{ ID::exp_track_input, Tip_For::exp_track_input() },
