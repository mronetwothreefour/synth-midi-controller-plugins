...
namespace constants
{
	namespace GUI
	{
		...
		static const Rectangle<int> bounds_RandomizationAllowedSyncedFreqForLFO{ randomizationAllowedSyncedFreqForLFOComponent_x, randomizationAllowedSyncedFreqForLFOComponent_y, randomizationAllowedSyncedFreqComponent_w, randomizationAllowedSyncedFreqComponent_h };
