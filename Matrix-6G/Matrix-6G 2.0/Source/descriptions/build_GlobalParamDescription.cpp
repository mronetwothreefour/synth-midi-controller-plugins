...
String GlobalParamDescription::buildForVoiceMapInVoice(uint8 mapNum) {
    String descriptionString{ "" };
    descriptionString += "When the Patch Map is enabled, a MIDI program change\n";
    descriptionString += "message calling program " + (String)mapNum + " will load the patch selected\n";
...
String GlobalParamDescription::buildForVoiceMapOutVoice(uint8 mapNum) {
    String descriptionString{ "" };
    descriptionString += "When the Patch Map and Patch Map Echo are both enabled\n";
    descriptionString += "and a MIDI program change message calling program " + (String)mapNum + " is\n";
