...
class LinearSliderWithMouseWheelMoveOverrideAndInvertedRange : 
	public SliderWithMouseWheelMoveOverride
{
public:
	LinearSliderWithMouseWheelMoveOverrideAndInvertedRange() = delete;

	explicit LinearSliderWithMouseWheelMoveOverrideAndInvertedRange(UndoManager* undoManager);
