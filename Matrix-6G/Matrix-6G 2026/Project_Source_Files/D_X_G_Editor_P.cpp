...
Editor_P::Editor_P(Audio_Processor_P& processor, Data_Hub_P* hub) :
    ...
    cbox{ new Combo_Box_Exposed_B{ 68, hub } }
{
...
void Editor_P::resized() {
    ...
    Rectangle<int> cbox_bounds{ 0, 0, exp_info.ctrl_width_for(68), ctrl_h };
    cbox_bounds.setCentre(exp_info.ctrl_center_for(68));
    cbox->setBounds(cbox_bounds.transformedBy(AffineTransform::scale(scale_factor)));
}
