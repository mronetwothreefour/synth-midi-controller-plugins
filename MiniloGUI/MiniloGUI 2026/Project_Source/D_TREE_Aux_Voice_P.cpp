	...
	u_m{ u_m }
{
	...
	set_assignable_slider_target(Slider_Target::pitch_bend);
...
const Assignable_Slider_Target Tree_Additional_Voice_P::assignable_slider_target() {
	return Assignable_Slider_Target{ (int)tree[ID::avp_02_slider_target] };
}

void Tree_Additional_Voice_P::set_assignable_slider_target(const Assignable_Slider_Target new_setting) {
	u_m->beginNewTransaction();
