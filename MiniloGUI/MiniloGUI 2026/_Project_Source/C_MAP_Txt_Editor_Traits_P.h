...
namespace MAP
{
	...
	static const unordered_map<string, tuple<string, int, string>> txt_editor_traits{
		...
		{ ID::avp_fine_tune, { allowed_chars_s_int, 3, Tip_For::txt_editor_s_int(50) } },
		{ ID::avp_flex_sli_bend_neg, txt_editor_traits_flex_sli_bend },
		{ ID::avp_flex_sli_bend_pos, txt_editor_traits_flex_sli_bend },
		{ ID::avp_flex_sli_range, { allowed_chars_s_int, 4, Tip_For::txt_editor_s_int(100) } },
		{ ID::avp_level, { allowed_chars_s_int, 3, Tip_For::txt_editor_s_int(25) } },
		{ ID::avp_porta_time, txt_editor_traits_u_7_bit },
		{ ID::avp_scale_key, { allowed_chars_u_int, 2, Tip_For::txt_editor_u_int(24) } },
		{ ID::avp_transpose, { allowed_chars_s_int, 3, Tip_For::txt_editor_s_int(12) } },
		...
		{ ID::exp_osc_2_pitch_eg_int, { allowed_chars_s_int, 5, Tip_For::txt_editor_s_int(4800) } },
		...
		{ ID::exp_lpf_eg_int, { allowed_chars_s_int, 4, Tip_For::txt_editor_s_int(100) } },
