...
namespace constants
{
	namespace GUI
	{
		...
		static const int randomizationLFOoptionsBackground_x{ 298 };
		static const int randomizationLFOoptionsBackground_y{ 223 };
		...
		static const int randomizationOscOptionsShowButton_x{ 146 };
