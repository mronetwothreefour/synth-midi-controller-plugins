	...
	exposedParamsInfoTree{ ID::tree_ExposedParamsInfo }
{
	...
	for (auto oscNum = 1; oscNum != 3; ++oscNum) {
		...
		exposedParamsInfoTree.addChild(
			ValueTree{ oscNum == 1 ? "ep_000" : "ep_006", {
					...
					{ ID::property_KnobTextEditorType, (int)KnobTextEditorType::oscPitch },
					{ ID::property_NRPN, oscNum == 1 ? 0 : 5 },
					{ ID::property_NumberOfChoices, EP::numberOfChoicesForOscPitch },
					{ ID::property_DefaultChoice, 24 },
					{ ID::property_ControlCenter_x, controlsCol_1_x },
					{ ID::property_ControlCenter_y, center_y },
		...
		exposedParamsInfoTree.addChild(
			ValueTree{ oscNum == 1 ? "ep_001" : "ep_007", {
					...
					{ ID::property_KnobTextEditorType, (int)KnobTextEditorType::oscFineTune },
					...
					{ ID::property_ControlCenter_x, controlsCol_2_x },
					{ ID::property_ControlCenter_y, center_y },
					{ ID::property_Control_w, GUI::knob_diameter },
					{ ID::property_Control_h, GUI::knob_diameter },
		...
		exposedParamsInfoTree.addChild(
			ValueTree{ oscNum == 1 ? "ep_003" : "ep_009", {
					...
					{ ID::property_ControlType, (int)ControlType::knob },
					{ ID::property_KnobTextEditorType, (int)KnobTextEditorType::pos_127 },
					{ ID::property_NRPN, oscNum == 1 ? 3 : 8 },
					{ ID::property_NumberOfChoices, 128 },
					{ ID::property_DefaultChoice, 0 },
					{ ID::property_ControlCenter_x, controlsCol_4_x },
					{ ID::property_ControlCenter_y, center_y },
					{ ID::property_Control_w, GUI::knob_diameter },
					{ ID::property_Control_h, GUI::knob_diameter },
		...
		exposedParamsInfoTree.addChild(
			ValueTree{ oscNum == 1 ? "ep_004" : "ep_010", {
					...
					{ ID::property_DefaultChoice, 1 },
					{ ID::property_ControlCenter_x, controlsCol_6_x },
					{ ID::property_ControlCenter_y, center_y + 11 },
					{ ID::property_Control_w, 32 },
					{ ID::property_Control_h, 36 },
		...
		exposedParamsInfoTree.addChild(
			ValueTree{ oscNum == 1 ? "ep_005" : "ep_011", {
					...
					{ ID::property_NumberOfChoices, 128 },
					{ ID::property_DefaultChoice, 0 },
					{ ID::property_ControlCenter_x, controlsCol_5_x },
					{ ID::property_ControlCenter_y, center_y },
					{ ID::property_Control_w, GUI::knob_diameter },
					{ ID::property_Control_h, GUI::knob_diameter },
	...
	exposedParamsInfoTree.addChild(
		ValueTree{ "ep_012", {
				...
				{ ID::property_NumberOfChoices, 2 },
				{ ID::property_DefaultChoice, 0 },
				{ ID::property_ControlCenter_x, 242 },
				{ ID::property_ControlCenter_y, 22 },
				{ ID::property_Control_w, 76 },
				{ ID::property_Control_h, GUI::redToggle_diameter },
	...
	exposedParamsInfoTree.addChild(
		ValueTree{ "ep_013", {
				...
				{ ID::property_DefaultChoice, 0 },
				{ ID::property_ControlCenter_x, controlsCol_10_x },
				{ ID::property_ControlCenter_y, 78 },
				{ ID::property_Control_w, 124 },
				{ ID::property_Control_h, GUI::comboBox_h },
	...
	exposedParamsInfoTree.addChild(
		ValueTree{ "ep_014", {
				...
				{ ID::property_ControlType, (int)ControlType::knob },
				{ ID::property_KnobTextEditorType, (int)KnobTextEditorType::oscSlop },
				{ ID::property_NRPN, 12 },
				{ ID::property_NumberOfChoices, 6 },
				{ ID::property_DefaultChoice, 2 },
				{ ID::property_ControlCenter_x, controlsCol_7_x },
				{ ID::property_ControlCenter_y, oscRow_1_center_y },
				{ ID::property_Control_w, GUI::knob_diameter },
				{ ID::property_Control_h, GUI::knob_diameter },
	...
	exposedParamsInfoTree.addChild(
		ValueTree{ "ep_015", {
				...
				{ ID::property_ControlType, (int)ControlType::knob },
				{ ID::property_KnobTextEditorType, (int)KnobTextEditorType::pitchBend },
				{ ID::property_NRPN, 93 },
				{ ID::property_NumberOfChoices, EP::numberOfChoicesForBendRange },
				{ ID::property_DefaultChoice, 4 },
				{ ID::property_ControlCenter_x, controlsCol_9_x },
				{ ID::property_ControlCenter_y, oscRow_1_center_y },
				{ ID::property_Control_w, GUI::knob_diameter },
				{ ID::property_Control_h, GUI::knob_diameter },
	...
	exposedParamsInfoTree.addChild(
		ValueTree{ "ep_016", {
				...
				{ ID::property_DefaultChoice, 4 },
				{ ID::property_ControlCenter_x, controlsCol_10_x },
				{ ID::property_ControlCenter_y, 38 },
				{ ID::property_Control_w, 124 },
				{ ID::property_Control_h, GUI::comboBox_h },
	...
	exposedParamsInfoTree.addChild(
		ValueTree{ "ep_017", {
				...
				{ ID::property_ControlCenter_x, controlsCol_8_x },
				{ ID::property_ControlCenter_y, oscRow_1_center_y },
				{ ID::property_Control_w, GUI::knob_diameter },
				{ ID::property_Control_h, GUI::knob_diameter },
	...
	exposedParamsInfoTree.addChild(
		ValueTree{ "ep_018", {
				...
				{ ID::property_DefaultChoice, 0 },
				{ ID::property_ControlCenter_x, controlsCol_7_x },
				{ ID::property_ControlCenter_y, oscRow_2_center_y },
				{ ID::property_Control_w, GUI::knob_diameter },
				{ ID::property_Control_h, GUI::knob_diameter },
	...
	exposedParamsInfoTree.addChild(
		ValueTree{ "ep_020", {
				...
				{ ID::property_ControlType, (int)ControlType::knobForPitch },
				{ ID::property_KnobTextEditorType, (int)KnobTextEditorType::lpfFrequency },
				{ ID::property_NRPN, 15 },
				{ ID::property_NumberOfChoices, EP::numberOfChoicesFor_LPF_Freq },
				{ ID::property_DefaultChoice, 148 },
				{ ID::property_ControlCenter_x, controlsCol_1_x },
				{ ID::property_ControlCenter_y, lpfRow_2_center_y },
				{ ID::property_Control_w, GUI::knob_diameter },
				{ ID::property_Control_h, GUI::knob_diameter },
	...
	exposedParamsInfoTree.addChild(
		ValueTree{ "ep_023", {
				...
				{ ID::property_DefaultChoice, 0 },
				{ ID::property_ControlCenter_x, controlsCol_3_x },
				{ ID::property_ControlCenter_y, lpfRow_3_center_y },
				{ ID::property_Control_w, GUI::knob_diameter },
				{ ID::property_Control_h, GUI::knob_diameter },
	...
	exposedParamsInfoTree.addChild(
		ValueTree{ "ep_024", {
				...
				{ ID::property_DefaultChoice, 1 },
				{ ID::property_ControlCenter_x, controlsCol_2_x },
				{ ID::property_ControlCenter_y, lpfRow_1_center_y },
				{ ID::property_Control_w, 34 },
				{ ID::property_Control_h, 26 },
	...
	exposedParamsInfoTree.addChild(
		ValueTree{ "ep_025", {
				...
				{ ID::property_ControlType, (int)ControlType::knob },
				{ ID::property_KnobTextEditorType, (int)KnobTextEditorType::posNeg_127 },
				{ ID::property_NRPN, 20 },
	...
	exposedParamsInfoTree.addChild(
		ValueTree{ "ep_032", {
				...
				{ ID::property_DefaultChoice, 0 },
				{ ID::property_ControlCenter_x, controlsCol_1_x },
				{ ID::property_ControlCenter_y, vcaRow_1_center_y },
				{ ID::property_Control_w, GUI::knob_diameter },
				{ ID::property_Control_h, GUI::knob_diameter },
	...
	exposedParamsInfoTree.addChild(
		ValueTree{ "ep_035", {
				...
				{ ID::property_DefaultChoice, 0 },
				{ ID::property_ControlCenter_x, controlsCol_4_x },
				{ ID::property_ControlCenter_y, vcaRow_2_center_y },
				{ ID::property_Control_w, GUI::knob_diameter },
				{ ID::property_Control_h, GUI::knob_diameter },
	...
	for (uint8 lfoNum = 0; lfoNum != 4; ++lfoNum) {
		...
		exposedParamsInfoTree.addChild(
			ValueTree{ paramNumString, {
					...
					{ ID::property_ControlType, (int)ControlType::knob },
					{ ID::property_KnobTextEditorType, (int)KnobTextEditorType::lfoFrequency },
					{ ID::property_NRPN, nrpn },
					{ ID::property_NumberOfChoices, 167 },
					{ ID::property_DefaultChoice, 80 },
					{ ID::property_ControlCenter_x, 416 + lfoNum * lfoControlsGroup_w },
					{ ID::property_ControlCenter_y, lfoRow_1_center_y },
					{ ID::property_Control_w, GUI::knob_diameter },
					{ ID::property_Control_h, GUI::knob_diameter },
		...
		exposedParamsInfoTree.addChild(
			ValueTree{ paramNumString, {
					...
					{ ID::property_DefaultChoice, 1 },
					{ ID::property_ControlCenter_x, 463 + lfoNum * lfoControlsGroup_w },
					{ ID::property_ControlCenter_y, lfoRow_2_center_y },
					{ ID::property_Control_w, 134 },
					{ ID::property_Control_h, GUI::comboBox_h },
		...
		exposedParamsInfoTree.addChild(
			ValueTree{ paramNumString, {
					...
					{ ID::property_NumberOfChoices, 128 },
					{ ID::property_DefaultChoice, 0 },
					{ ID::property_ControlCenter_x, 461 + lfoNum * lfoControlsGroup_w },
					{ ID::property_ControlCenter_y, lfoRow_1_center_y },
					{ ID::property_Control_w, GUI::knob_diameter },
					{ ID::property_Control_h, GUI::knob_diameter },
		...
		exposedParamsInfoTree.addChild(
			ValueTree{ paramNumString, {
					...
					{ ID::property_DefaultChoice, 0 },
					{ ID::property_ControlCenter_x, 463 + lfoNum * lfoControlsGroup_w },
					{ ID::property_ControlCenter_y, lfoRow_3_center_y },
					{ ID::property_Control_w, 134 },
					{ ID::property_Control_h, GUI::comboBox_h },
		...
		exposedParamsInfoTree.addChild(
			ValueTree{ paramNumString, {
					...
					{ ID::property_NumberOfChoices, 2 },
					{ ID::property_DefaultChoice, 0 },
					{ ID::property_ControlCenter_x, 507 + lfoNum * lfoControlsGroup_w },
					{ ID::property_ControlCenter_y, 526 },
					{ ID::property_Control_w, 26 },
					{ ID::property_Control_h, 36 },
	...
	exposedParamsInfoTree.addChild(
		ValueTree{ "ep_061", {
				...
				{ ID::property_DefaultChoice, 0 },
				{ ID::property_ControlCenter_x, controlsCol_2_x },
				{ ID::property_ControlCenter_y, env_3_ControlsRow_2_y },
				{ ID::property_Control_w, 126 },
				{ ID::property_Control_h, GUI::comboBox_h },
	...
	exposedParamsInfoTree.addChild(
		ValueTree{ "ep_062", {
				...
				{ ID::property_DefaultChoice, 127 },
				{ ID::property_ControlCenter_x, controlsCol_2_x },
				{ ID::property_ControlCenter_y, env_3_ControlsRow_1_y },
				{ ID::property_Control_w, GUI::knob_diameter },
				{ ID::property_Control_h, GUI::knob_diameter },
	...
	exposedParamsInfoTree.addChild(
		ValueTree{ "ep_069", {
				...
				{ ID::property_DefaultChoice, 0 },
				{ ID::property_ControlCenter_x, controlsCol_1_x },
				{ ID::property_ControlCenter_y, 537 },
				{ ID::property_Control_w, 34 },
				{ ID::property_Control_h, 26 },
	...
	for (uint8 modNum = 0; modNum != 4; ++modNum) {
		...
		exposedParamsInfoTree.addChild(
			ValueTree{ paramNumString, {
					...
					{ ID::property_DefaultChoice, 0 },
					{ ID::property_ControlCenter_x, modulatorControlsCol_1_x },
					{ ID::property_ControlCenter_y, 184 + modNum * modulatorControlsGroup_h },
					{ ID::property_Control_w, modulatorComboBox_w },
					{ ID::property_Control_h, GUI::comboBox_h },
		...
		exposedParamsInfoTree.addChild(
			ValueTree{ paramNumString, {
					...
					{ ID::property_NumberOfChoices, 255 },
					{ ID::property_DefaultChoice, 127 },
					{ ID::property_ControlCenter_x, modulatorControlsCol_2_x },
					{ ID::property_ControlCenter_y, 201 + modNum * modulatorControlsGroup_h },
					{ ID::property_Control_w, GUI::knob_diameter },
					{ ID::property_Control_h, GUI::knob_diameter },
		...
		exposedParamsInfoTree.addChild(
			ValueTree{ paramNumString, {
					...
					{ ID::property_DefaultChoice, 0 },
					{ ID::property_ControlCenter_x, modulatorControlsCol_1_x },
					{ ID::property_ControlCenter_y, 218 + modNum * modulatorControlsGroup_h },
					{ ID::property_Control_w, modulatorComboBox_w },
					{ ID::property_Control_h, GUI::comboBox_h },
	...
	exposedParamsInfoTree.addChild(
		ValueTree{ "ep_082", {
				...
				{ ID::property_NumberOfChoices, 255 },
				{ ID::property_DefaultChoice, 127 },
				{ ID::property_ControlCenter_x, midiControllersCol_2_x },
				{ ID::property_ControlCenter_y, midiControllersRow_1_y },
				{ ID::property_Control_w, GUI::knob_diameter },
				{ ID::property_Control_h, GUI::knob_diameter },
	...
	exposedParamsInfoTree.addChild(
		ValueTree{ "ep_083", {
				...
				{ ID::property_NumberOfChoices, EP::numberOfChoicesForModDest },
				{ ID::property_DefaultChoice, 0 },
				{ ID::property_ControlCenter_x, midiControllersCol_1_x },
				{ ID::property_ControlCenter_y, midiControllersRow_1_y },
				{ ID::property_Control_w, midiControllerComboBox_w },
				{ ID::property_Control_h, GUI::comboBox_h },
	...
	exposedParamsInfoTree.addChild(
		ValueTree{ "ep_084", {
				...
				{ ID::property_DefaultChoice, 127 },
				{ ID::property_ControlCenter_x, midiControllersCol_2_x },
				{ ID::property_ControlCenter_y, midiControllersRow_2_y },
				{ ID::property_Control_w, GUI::knob_diameter },
				{ ID::property_Control_h, GUI::knob_diameter },
	...
	exposedParamsInfoTree.addChild(
		ValueTree{ "ep_086", {
				...
				{ ID::property_DefaultChoice, 127 },
				{ ID::property_ControlCenter_x, midiControllersCol_2_x },
				{ ID::property_ControlCenter_y, midiControllersRow_3_y },
				{ ID::property_Control_w, GUI::knob_diameter },
				{ ID::property_Control_h, GUI::knob_diameter },
	...
	exposedParamsInfoTree.addChild(
		ValueTree{ "ep_088", {
				...
				{ ID::property_DefaultChoice, 127 },
				{ ID::property_ControlCenter_x, midiControllersCol_2_x },
				{ ID::property_ControlCenter_y, midiControllersRow_4_y },
				{ ID::property_Control_w, GUI::knob_diameter },
				{ ID::property_Control_h, GUI::knob_diameter },
	...
	exposedParamsInfoTree.addChild(
		ValueTree{ "ep_090", {
				...
				{ ID::property_DefaultChoice, 127 },
				{ ID::property_ControlCenter_x, midiControllersCol_2_x },
				{ ID::property_ControlCenter_y, midiControllersRow_5_y },
				{ ID::property_Control_w, GUI::knob_diameter },
				{ ID::property_Control_h, GUI::knob_diameter },
	...
	exposedParamsInfoTree.addChild(
		ValueTree{ "ep_092", {
				...
				{ ID::property_ControlCenter_x, 1191 },
				{ ID::property_ControlCenter_y, pushiItKnobsRow_y },
				{ ID::property_Control_w, GUI::knob_diameter },
				{ ID::property_Control_h, GUI::knob_diameter },
	...
	exposedParamsInfoTree.addChild(
		ValueTree{ "ep_093", {
				...
				{ ID::property_ControlCenter_x, 1239 },
				{ ID::property_ControlCenter_y, pushiItKnobsRow_y },
				{ ID::property_Control_w, GUI::knob_diameter },
				{ ID::property_Control_h, GUI::knob_diameter },
	...
	exposedParamsInfoTree.addChild(
		ValueTree{ "ep_094", {
				...
				{ ID::property_DefaultChoice, 0 },
				{ ID::property_ControlCenter_x, 1215 },
				{ ID::property_ControlCenter_y, 577 },
				{ ID::property_Control_w, 88 },
				{ ID::property_Control_h, GUI::comboBox_h },
	...
	exposedParamsInfoTree.addChild(
		ValueTree{ "ep_095", {
				...
				{ ID::property_ControlType, (int)ControlType::knob },
				{ ID::property_KnobTextEditorType, (int)KnobTextEditorType::clockTempo },
				{ ID::property_NRPN, 91 },
				{ ID::property_NumberOfChoices, EP::numberOfChoicesForClockTempo },
				{ ID::property_DefaultChoice, 90 },
				{ ID::property_ControlCenter_x, 1236 },
				{ ID::property_ControlCenter_y, clockAndSequencerControlsRow_y },
				{ ID::property_Control_w, GUI::knob_diameter },
				{ ID::property_Control_h, GUI::knob_diameter },
	...
	exposedParamsInfoTree.addChild(
		ValueTree{ "ep_096", {
				...
				{ ID::property_DefaultChoice, 2 },
				{ ID::property_ControlCenter_x, 1139 },
				{ ID::property_ControlCenter_y, clockAndSequencerControlsRow_y },
				{ ID::property_Control_w, 126 },
				{ ID::property_Control_h, GUI::comboBox_h },
	...
	exposedParamsInfoTree.addChild(
		ValueTree{ "ep_097", {
				...
				{ ID::property_DefaultChoice, 0 },
				{ ID::property_ControlCenter_x, controlsCol_10_x },
				{ ID::property_ControlCenter_y, 118 },
				{ ID::property_Control_w, 124 },
				{ ID::property_Control_h, GUI::comboBox_h },
	...
	exposedParamsInfoTree.addChild(
		ValueTree{ "ep_098", {
				...
				{ ID::property_DefaultChoice, 0 },
				{ ID::property_ControlCenter_x, controlsCol_9_x },
				{ ID::property_ControlCenter_y, 116 },
				{ ID::property_Control_w, 20 },
				{ ID::property_Control_h, 26 },
	...
	exposedParamsInfoTree.addChild(
		ValueTree{ "ep_099", {
				...
				{ ID::property_NumberOfChoices, 6 },
				{ ID::property_DefaultChoice, 0 },
				{ ID::property_ControlCenter_x, 998 },
				{ ID::property_ControlCenter_y, clockAndSequencerControlsRow_y },
				{ ID::property_Control_w, 114 },
				{ ID::property_Control_h, GUI::comboBox_h },
	...
	exposedParamsInfoTree.addChild(
		ValueTree{ "ep_100", {
				...
				{ ID::property_NumberOfChoices, 2 },
				{ ID::property_DefaultChoice, 0 },
				{ ID::property_ControlCenter_x, 863 },
				{ ID::property_ControlCenter_y, clockAndSequencerControlsRow_y },
				{ ID::property_Control_w, 102 },
				{ ID::property_Control_h, GUI::redToggle_diameter },
		...
		exposedParamsInfoTree.addChild(
			ValueTree{ paramNumString, {
				{ ID::property_ParamID, paramID_String },
					...
					{ ID::property_ControlCenter_x, seqTrackDestComboBoxes_x },
					{ ID::property_ControlCenter_y, 169 + ((trackNum - 1) * GUI::seqTrackControlsGroup_h) },
					{ ID::property_Control_w, seqTrackDestComboBoxes_w },
					{ ID::property_Control_h, GUI::comboBox_h },
		...
		exposedParamsInfoTree.addChild(
			ValueTree{ paramNumString, {
				{ ID::property_ParamID, paramID_String },
					...
					{ ID::property_ControlCenter_x, knobAssignComboBoxes_x },
					{ ID::property_ControlCenter_y, 521 + (knobNum - 1) * knobAssignComboBoxesVertSpacing },
					{ ID::property_Control_w, knobAssignComboBoxes_w },
					{ ID::property_Control_h, GUI::comboBox_h },
		...
		for (auto stepNum = 0; stepNum != 16; ++stepNum) {
			...
			exposedParamsInfoTree.addChild(
				ValueTree{ paramNumString, {
						...
						{ ID::property_DefaultChoice, 0 },
						{ ID::property_ControlCenter_x, 825 + stepNum * (GUI::seqSteps_w + gapBetweenSeqStepsAndVoiceNameChars) },
						{ ID::property_ControlCenter_y, 196 + trackNum * GUI::seqTrackControlsGroup_h },
						{ ID::property_Control_w, GUI::seqSteps_w },
						{ ID::property_Control_h, GUI::seqSteps_h },
	...
	for (auto charNum = 0; charNum != VCS::numberOfCharsInVoiceName; ++charNum) {
		...
		exposedParamsInfoTree.addChild(
			ValueTree{ "ep_" + paramNumString, {
					...
					{ ID::property_ControlCenter_x, 596 + charNum * (GUI::voiceNameChars_w + gapBetweenSeqStepsAndVoiceNameChars) },
					{ ID::property_ControlCenter_y, voiceNameCharacters_y },
					{ ID::property_Control_w, GUI::voiceNameChars_w },
					{ ID::property_Control_h, GUI::voiceNameChars_h },
