...
Editor_P::Editor_P(Audio_Processor_P& processor, Data_Hub_P* hub) :
    ...
    cbox_1{ new Combo_Box_Exposed_B{ 13, hub } },
    cbox_2{ new Combo_Box_Exposed_B{ 61, hub } }
{
...
void Editor_P::resized() {
    ...
    Rectangle<int> cbox_1_bounds{ 0, 0, exp_info.ctrl_width_for(13), cbox_h };
    cbox_1_bounds.setCentre(exp_info.ctrl_center_for(13));
    cbox_1->setBounds(cbox_1_bounds.transformedBy(AffineTransform::scale(scale_factor)));
    Rectangle<int> cbox_2_bounds{ 0, 0, exp_info.ctrl_width_for(61), cbox_h };
    cbox_2_bounds.setCentre(exp_info.ctrl_center_for(61));
