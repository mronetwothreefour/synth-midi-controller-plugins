...
namespace SL
{
    ...
    constexpr auto env_amp_tip = u8R"(
...
Range: 0 (no modulation) to 63 (maximum modulation).)";
    ...
    constexpr auto env_attack_tip = u8R"(
...
Range: 0 (instantaneous) to 63 (longest).)";
    ...
    constexpr auto env_decay_tip = u8R"(
...
Range: 0 (instantaneous) to 63 (longest).)";
    ...
    constexpr auto env_delay_tip = u8R"(
...
Range: 0 (instantaneous) to 63 (longest).)";
    ...
    constexpr auto env_lfo_1_trig_tip = u8R"(
...
in LFO 1’s cycle where the envelope’s cycle gets triggered.)";
    ...
    constexpr auto env_mode_tip = u8R"(
...
begins immediately after the decay stage, even if the note is still gated on.)";
    ...
    constexpr auto env_release_tip = u8R"(
...
Range: 0 (instantaneous) to 63 (longest).)";
    ...
    constexpr auto env_sustain_tip = u8R"(
...
Range: 0 (minimum) to 63 (maximum).)";
    ...
    constexpr auto env_trig_mode_tip = u8R"(
...
• XMTRIG (external multiple trigger) | • XMRST (external multiple trigger reset))";
    ...
    constexpr auto env_velo_amt_tip = u8R"(
...
the entire patch using the PUSH button instead.)";
    ...
    constexpr auto keyboard_mode_tip = u8R"(
...
‘rob’ a voice from one of the notes that are already playing.)";
    ...
    constexpr auto lfo_1_pressure_amt_tip = u8R"(
...
the entire patch using the PUSH button instead.)";
    ...
    constexpr auto lfo_2_key_track_amt_tip = u8R"(
...
using the PUSH button instead.)";
    ...
    constexpr auto lfo_amp_tip = u8R"(
Sets the degree to which LFO _ modulates its destination(s).
Range: 0 (no modulation) to 63 (maximum modulation).)";

    constexpr auto lfo_lag_tip = u8R"(
...
The effect will be most apparent on a square wave cycle.)";
    ...
    constexpr auto lfo_ramp_amt_tip = u8R"(
...
patch using the PUSH button instead.)";
    ...
    constexpr auto lfo_retrig_point_tip = u8R"(
...
Range: 0 (slowest) to 63 (fastest).)";
    ...
    constexpr auto lfo_trig_mode_tip = u8R"(
...
• XTRIG (external): An external signal (e.g. a footswitch) triggers the LFO.)";
    ...
    constexpr auto lfo_wave_type_tip = u8R"(
...
the entire patch using the PUSH button instead.)";
    ...
    constexpr auto osc_balance_tip = u8R"(
...
At 0, only oscillator 2 is heard. 31 is an equal mix.)";
    ...
    constexpr auto osc_key_click_tip = u8R"(
Adds percussive punch to
the start of the sound.)";

    constexpr auto osc_1_key_track_tip = u8R"(
...
smoothed according to the settings in the Portamento section.)";
    ...
    constexpr auto osc_2_key_track_tip = u8R"(
...
• KEYBD: Oscillator 2’s pitch tracks note key changes normally.)";
    ...
    constexpr auto osc_lever_control_tip = u8R"(
...
patch using the PUSH button instead.)";
    ...
    constexpr auto osc_lfo_2_pwm_tip = u8R"(
...
patch using the PUSH button instead.)";
    ...
    constexpr auto osc_pitch_tip = u8R"(
...
ment the pitch by one octave (12 semitones).)";
    ...
    constexpr auto osc_pulse_w_tip = u8R"(
...
A value of 31 produces a square wave.)";
    ...
    constexpr auto osc_saw_tri_tip = u8R"(
...
blends of these two shapes.)";
    ...
    constexpr auto osc_type_tip = u8R"(
...
• NOISE: White noise (oscillator 2 only).)";
    ...
    constexpr auto porta_legato_tip = u8R"(
...
the keyboard mode is set to unison.)";
    ...
    constexpr auto porta_mode_tip = u8R"(
...
will be shaped by the tracking generator.)";
    ...
    constexpr auto track_point_tip = u8R"(
Tracking Point _
Range: 0 to 63.
Linear output value: %.)";

    constexpr auto vca_1_velo_amt_tip = u8R"(
...
patch using the PUSH button instead.)";
    ...
    constexpr auto vcf_env_1_amt_tip = u8R"(
...
patch using the PUSH button instead.)";
    ...
    constexpr auto vcf_fm_env_3_amt_tip = u8R"(
Sets whether and to what degree
...
patch using the PUSH button instead.)";
    ...
    constexpr auto vcf_fm_osc_1_amt_tip = u8R"(
Sets whether and to what degree oscillator 1
modulates the VCF’s cutoff frequency.
Range: 0 (no modulation) to 63 (maximum).)";

    constexpr auto vcf_fm_pressure_amt_tip = u8R"(
Sets whether and to what degree keyboard
...
patch using the PUSH button instead.)";
    ...
    constexpr auto vcf_freq_tip = u8R"(
Sets the base cutoff frequency
of the voltage-controlled filter.
Range: 0 to 127.)";

    constexpr auto vcf_key_track_tip = u8R"(
...
higher notes are played and dropping as lower notes are played.)";
    ...
    constexpr auto vcf_lever_ctrl_tip = u8R"(
Selects which of the performance ‘levers’
...
the entire patch using the PUSH button instead.)";
    ...
    constexpr auto vcf_reso_tip = u8R"(
