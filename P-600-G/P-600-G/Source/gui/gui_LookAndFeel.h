...
public:
	...
	void drawScrollbar(Graphics& g, ScrollBar& scrollbar, int x, int y, int w, int h, bool isVertical, int thumbStartPosition, int thumbSize, bool mouseIsOver, bool mouseIsDown) override;
