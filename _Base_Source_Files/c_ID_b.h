...
namespace ID
{
	...
	static const Identifier exp_p_ctrl_center_y{ "exp_p_ctrl_center_y" };
	static const Identifier exp_p_ctrl_height{ "exp_p_ctrl_height" };
	static const Identifier exp_p_ctrl_type{ "exp_p_ctrl_type" };
