...
ValueTree Subtree_Choices_Exp_P::voice_mode_depth(const bool curt) {
    ...
    for (uint16 n = 0; n < EXP::choice_count_unsigned_10_bit; ++n) {
        ...
        choiceName += choice_voice_mode_5_chord(n, curt);
        choiceName += choice_voice_mode_6_delay(n, curt);
        choiceName += choice_voice_mode_7_arp(n, curt);
        choiceName += choice_voice_mode_8_sidechain(n, curt);
...
String Subtree_Choices_Exp_P::choice_voice_mode_1_poly(const uint16 n, const bool curt) {
...
String Subtree_Choices_Exp_P::choice_voice_mode_4_mono(const uint16 n, const bool curt) {
...
String Subtree_Choices_Exp_P::choice_voice_mode_7_arp(const uint16 n, const bool curt) {
    String name{ "|7:" };
...
String Subtree_Choices_Exp_P::choice_voice_mode_8_sidechain(const uint16 n, const bool curt) {
