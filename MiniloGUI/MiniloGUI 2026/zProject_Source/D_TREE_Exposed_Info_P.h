...
public: const String choice_for_lfo_rate(const bool bpm_synced, const int choice_num,
										 bool curt = false) const;
public: const String choice_for_voice_mode(const Voice_Mode mode, const int choice_num,
										   bool curt = false) const;
