...
Tree_Exposed_Info_P::Tree_Exposed_Info_P()
{
	...
	for (auto osc = 1; osc < 3; ++osc) {
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				osc == 1 ? 1 : 6, Range_Type::u_int, Display::osc_pitch,
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				Range_Type::u_int, Display::none, osc == 1 ? 4 : 5, osc == 1 ? 2 : 1, center_x,
				ctrl_row_02_y, osc_ctrl_w, Tip_Exp::osc_type(osc),
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				Range_Type::u_int, Display::u_int, 64, osc == 1 ? 31 : 24, center_x, ctrl_row_03_y,
				osc_ctrl_w, Tip_Exp::osc_pulse_w(osc), Choices_Exp::u_int(64, curt),
				Choices_Exp::u_int(64)
			), 
			-1, nullptr);
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				osc == 1 ? 2 : 7, Range_Type::u_int, Display::u_int, 64, 31, center_x, ctrl_row_04_y,
				osc_ctrl_w, Tip_Exp::osc_saw_tri(osc), Choices_Exp::u_int(64, curt),
				Choices_Exp::u_int(64)
			), 
			-1, nullptr);
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				osc == 1 ? Range_Type::u_int : Range_Type::s_6_bit_int, 
				osc == 1 ? Display::none : Display::s_6_bit_int,
				osc == 1 ? 4 : 63, osc == 1 ? 0 : 33, center_x, ctrl_row_05_y, osc_ctrl_w,
				osc == 1 ? Tip_Exp::osc_1_sync() : Tip_Exp::osc_2_detune(),
				osc == 1 ? Choices_Exp::osc_1_sync(curt) : Choices_Exp::s_6_bit_int(curt),
				osc == 1 ? Choices_Exp::osc_1_sync() : Choices_Exp::s_6_bit_int()
			), 
			-1, nullptr);
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				osc == 1 ? 78 : 80, Range_Type::s_7_bit_int, Display::s_7_bit_int,
				127, 63, center_x, ctrl_row_06_y, osc_ctrl_w, Tip_Exp::osc_lfo_1_fm(osc),
				Choices_Exp::s_7_bit_int(curt), Choices_Exp::s_7_bit_int()
			), 
			-1, nullptr);
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				osc == 1 ? 79 : 81, Range_Type::s_7_bit_int, Display::s_7_bit_int,
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				osc == 1 ? 14 : 16, Range_Type::u_int, Display::none,
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				osc == 1 ? 13 : 15, Range_Type::u_int, Display::none,
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				osc == 1 ? 4 : 9, Range_Type::u_int, Display::none,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			12, Range_Type::u_int, Display::u_int,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			Range_Type::u_int, Display::u_int, 128, 55,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			Range_Type::u_int, Display::u_int, 64, 0,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			82, Range_Type::s_7_bit_int, Display::s_7_bit_int, 127, 105,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			83, Range_Type::s_7_bit_int, Display::s_7_bit_int, 127, 63,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			20, Range_Type::u_int, Display::none, 4, 0,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			21, Range_Type::u_int, Display::none, 3, 2,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			23, Range_Type::u_int, Display::u_int, 64, 63,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			84, Range_Type::s_7_bit_int, Display::s_7_bit_int, 127, 63,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			85, Range_Type::s_7_bit_int, Display::s_7_bit_int, 127, 126,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			22, Range_Type::u_int, Display::u_int, 64, 0,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			92, Range_Type::s_7_bit_int, Display::s_7_bit_int, 127, 63,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			93, Range_Type::s_7_bit_int, Display::s_7_bit_int, 127, 63,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			24, Range_Type::u_int, Display::u_int, 64, 0,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			91, Range_Type::s_7_bit_int, Display::s_7_bit_int, 127, 63,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			25, Range_Type::u_int, Display::none, 3, 0,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			...
			26, Range_Type::u_int, Display::none, 2, 0,
	...
	tree.addChild(
		Subtree_Exposed_Info_P::build(
			keyboard_mode, 48, "Keyboard Mode", Ctrl_Type::cbox, 0, Range_Type::u_int,
	...
	for (int lfo = 1; lfo < 3; ++lfo) {
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				Range_Type::u_int, Display::u_int, 64,
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				Range_Type::u_int, Display::none, 7, 0,
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				lfo == 1 ? 94 : 95, Range_Type::s_7_bit_int, Display::s_7_bit_int,
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				lfo == 1 ? 89 : 90, Range_Type::s_7_bit_int, Display::s_7_bit_int,
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				Range_Type::u_int, Display::none, 4, 0,
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				Range_Type::u_int, Display::none, 2, 0,
	...
	for (int pt = 1; pt < 6; ++pt) {
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				Ctrl_Type::slider, 68 + pt, Range_Type::u_int, Display::u_int, 64,
				init_choice, track_pt_1_x + (pt - 1) * track_pt_spacing, track_pt_y, track_pt_w,
				Tip_Exp::track_point(pt, init_choice), Choices_Exp::u_int(64, curt),
				Choices_Exp::u_int(64)
			),
			-1, nullptr);
	}
	...
	for (int env = 0; env < 3; ++env) {
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				Range_Type::u_int, Display::u_int, 64, 40,
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				Range_Type::s_7_bit_int, Display::s_7_bit_int, 127, 126,
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				Range_Type::u_int, Display::none, 8, 0,
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				Range_Type::u_int, Display::none, 3, 0,
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				Range_Type::u_int, Display::u_int, 64, env == 2 ? 20 : 10,
		...
		tree.addChild(
			Subtree_Exposed_Info_P::build(
				...
				Range_Type::u_int, Display::u_int, 64, env == 2 ? 0 : 50,
