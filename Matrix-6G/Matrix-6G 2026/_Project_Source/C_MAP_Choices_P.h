...
namespace MAP
{
	...
	static const std::unordered_map<String, StringArray> choices{
		...
		{ ID::exp_osc_1_key_click, Choices_For::off_on_p() },
		...
		{ ID::exp_osc_2_key_click, Choices_For::off_on_p() },
		...
		{ ID::exp_porta_legato, Choices_For::off_on_p() },
		...
		{ ID::exp_lfo_2_lag, Choices_For::off_on_p() },
		//exposed ramp
