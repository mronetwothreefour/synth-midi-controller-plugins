...
ButtonForPullingSelectedVoiceFromHardware::ButtonForPullingSelectedVoiceFromHardware(VoiceSlotsComponent& slotsComponent, UnexposedParameters* unexposedParams, Label& nameEditor) :
