...
Turning it on will turn off the sequencer.)";
    ...
    constexpr auto bend_range_tip = u8R"(
...
Range: 0 to 127.)";
    ...
    constexpr auto ext_in_level_tip = u8R"(
...
Range: 0 to 127.)";
    ...
    constexpr auto lfo_freq_tip = u8R"(
...
Range: 0 to 127.)";
    ...
    constexpr auto lpf_freq_tip = u8R"(
...
increment the frequency by one octave (12 semitones).)";
    ...
    constexpr auto lpf_key_amt_tip = u8R"(
...
slope and more pronounced resonance.)";
    ...
    constexpr auto midi_breath_amt_tip = u8R"(
...
Range: -127 to +127.)";
    ...
    constexpr auto midi_mod_wheel_amt_tip = u8R"(
...
the pitch of incoming MIDI note messages.)";
    ...
    constexpr auto osc_mix_tip = u8R"(
...
Reset (126): Resets the sequence back to step 1. CTRL-click a step to set it to reset.
    ...
    constexpr auto seq_track_step_tip_2 = u8R"(
...
Rests are only available for the steps in sequencer track 1.
    ...
    constexpr auto seq_track_step_tip_3 = u8R"(
...
Range: 0 to 127.)";
    ...
    constexpr auto vca_level_tip = u8R"(
...
Range: 0 to 127.)";
    ...
    constexpr auto voice_name_char_tip = u8R"(
...
button above to type in the entire name.)";
    ...
    constexpr auto voice_volume_tip = u8R"(
