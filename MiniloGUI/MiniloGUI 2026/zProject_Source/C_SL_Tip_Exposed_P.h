...
namespace SL
{
    ...
    constexpr auto delay_feedback_tip = u8R"(
Sets the amount of
delay regeneration.
Transmits on CC #31.
Range: 0 to 1023.)";

    constexpr auto delay_routing_tip = u8R"(
...
output audio and the delay audio).)";
    ...
    constexpr auto delay_time_tip = u8R"(
Sets the delay time.
Transmits on CC #30.
Range: 0 (shortest)
1023 (longest).)";

    constexpr auto delay_hpf_freq_tip = u8R"(
...
Synced: 4 beats to 1/64 beat.)";
    ...
    constexpr auto lfo_target_tip = u8R"(
...
VCO 1 & 2 shape, VCO 1 & 2 pitch.)";
    ...
    constexpr auto lfo_wave_tip = u8R"(
Selects the LFO’s waveform.
Transmits on CC #58.
Choices: square, triangle,
sawtooth.)";

    constexpr auto lpf_eg_int_tip = u8R"(
...
Transmits on CC #43. Range: 0 to 1023.)";
    ...
    constexpr auto lpf_key_track_tip = u8R"(
...
slope and more pronounced resonance. Transmits on CC #84.)";
    ...
    constexpr auto lpf_velo_amt_tip = u8R"(
...
Choices: 0%, 50%, 100%. Transmits on CC #82.)";
    ...
    constexpr auto osc_2_pitch_eg_int_tip = u8R"(
...
Range: -4800 to +4800 cents (-4 to +4 octaves).)";
    ...
    constexpr auto osc_2_x_mod_depth_tip = u8R"(
...
Range: 0 to 1023.)";
    ...
    constexpr auto osc_octave_tip = u8R"(
Sets the root octave of oscillator _.
Transmits on CC #%%.
Range: 16' (lowest) to 2' (highest).)";

    constexpr auto osc_pitch_fine_tip = u8R"(
...
Transmits on CC #%%. Range: 0 to 1023.)";
    ...
    constexpr auto osc_wave_tip = u8R"(
Selects oscillator _’s base waveform.
Transmits on CC #%%.
Choices: square, triangle, sawtooth.)";

    constexpr auto voice_mode_depth_tip = u8R"(
