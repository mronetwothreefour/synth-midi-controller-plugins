...
//	}
//
//	void attachToPublicParameter(AudioProcessorValueTreeState* publicParams, Identifier paramID)
//	{
//		attachment.reset(new SliderAttachment(*publicParams, paramID.toString(), knob));
//	}
//
...
//	void attachToPublicParameter(AudioProcessorValueTreeState* publicParams, Identifier paramID)
//	{
//		knob.attachToPublicParameter(publicParams, paramID);
//	}
//};
//
//
...
//				knobWithValueStringDisplay->attachToPublicParameter(publicParams, paramID);
//			break;
//		default: break;
//		}
//	}
