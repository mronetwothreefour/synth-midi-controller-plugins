...
std::string Tip_For::exp_env_stage(const unsigned int env, const unsigned int stage)
{
    String s;
    switch (stage) {
    case 0: s = from_string_literal(SL::env_delay_tip); break;
    case 1: s = from_string_literal(SL::env_attack_tip); break;
    case 2: s = from_string_literal(SL::env_decay_tip); break;
    case 3: s = from_string_literal(SL::env_sustain_tip); break;
    case 4: s = from_string_literal(SL::env_release_tip); break;
