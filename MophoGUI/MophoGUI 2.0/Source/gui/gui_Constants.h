...
namespace constants
{
	namespace GUI
	{
		...
		static const Rectangle<int> bounds_RandomizationAllowedOctavesForOsc1{ randomizationAllowedOctavesForOsc1Component_x, randomizationAllowedOctavesForOscComponents_y, randomizationAllowedOctavesComponent_w, randomizationAllowedOctavesComponent_h };
		static const Rectangle<int> bounds_RandomizationAllowedOctavesForOsc2{ randomizationAllowedOctavesForOsc2Component_x, randomizationAllowedOctavesForOscComponents_y, randomizationAllowedOctavesComponent_w, randomizationAllowedOctavesComponent_h };
