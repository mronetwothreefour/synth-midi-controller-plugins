...
String GlobalParamDescription::buildFor_AudioOutput() {
...
String GlobalParamDescription::buildFor_DescriptionTooltip() {
    String descriptionString{ "" };
...
String GlobalParamDescription::buildFor_GlobalFineTune() {
    String descriptionString{ "" };
...
String GlobalParamDescription::buildFor_GlobalTranspose() {
    String descriptionString{ "" };
...
String GlobalParamDescription::buildFor_HardwareReceiveChannel() {
    String descriptionString{ "" };
...
String GlobalParamDescription::buildFor_MIDI_ControllersStatus() {
    String descriptionString{ "" };
...
String GlobalParamDescription::buildFor_ParamChangeSendType() {
    String descriptionString{ "" };
...
String GlobalParamDescription::buildFor_ParamChangeReceiveType() {
    String descriptionString{ "" };
...
String GlobalParamDescription::buildFor_PedalMode() {
    String descriptionString{ "" };
...
String GlobalParamDescription::buildFor_SysExStatus() {
    String descriptionString{ "" };
...
String GlobalParamDescription::buildFor_TooltipDelay() {
    String descriptionString{ "" };
