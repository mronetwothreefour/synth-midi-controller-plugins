...
//==============================================================================
public: explicit Tree_Additional_Voice_P(UndoManager* u_m);
...
public: const Slider_Target slider_target();
public: void set_slider_target(const Slider_Target new_setting);

public: const int slider_range();
public: void set_slider_range(const int new_setting);

public: const int slider_range_pitch_bend(const bool pos_limit);
public: void set_slider_range_pitch_bend(const bool pos_limit, const int new_setting);
...
public: Value get_param_as_value(const Identifier param_id);

public: const int byte_index_for_param_bit(const Identifier param_id, const int bit_index) const;
public: const int bit_index_for_param_bit(const Identifier param_id, const int bit_index) const;

public: std::unique_ptr<XmlElement> get_state();
public: void replace_state(const ValueTree& new_state);

//==============================================================================
private: JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(Tree_Additional_Voice_P)
};